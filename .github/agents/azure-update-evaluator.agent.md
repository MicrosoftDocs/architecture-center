...
tools: [vscode/askQuestions, read/problems, read/readFile, agent, edit/createFile, edit/editFiles, search, web, 'microsoft-learn-mcp-server/*', 'agency:-msft-learn/*', todo, ms-vscode.vscode-websearchforcopilot/websearch]
...
- Input: A JSON file that represents updates made to Azure. Ask the user for this if you don't have it added to your context, and don't search for it. Remind them that they can create this file by running `/scripts/fetch-azure-updates.sh`. Don't run this command for them.
