...
- **Bash tools are enabled by default** - Limit `bash` access to the commands the workflow needs, and use a narrow allowlist for workflows that process untrusted input.
