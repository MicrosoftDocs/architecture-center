...
1. **Build the todo list first.** Enumerate the review steps (below, plus any the invoker adds) as tracked tasks. Wait for the invoker to confirm the list before starting. Insert or drop steps when the invoker asks.
