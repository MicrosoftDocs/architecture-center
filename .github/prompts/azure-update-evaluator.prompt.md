...
- Input: A JSON file that represents updates made to Azure. Ask the user for this if you don't have it added to your context, don't go searching for it. Remind them they can create this file by using `/azure-update-report/fetch-azure-updates.sh`. Do not run this command for them.
