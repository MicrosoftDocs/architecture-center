...
| Private PaaS Connectivity |  [Azure PrivateLink](https://docs.aws.amazon.com/vpc/latest/userguide/endpoint-services-overview.html) | [Private Endpoint](https://docs.microsoft.com/en-us/azure/private-link/private-endpoint-overview/) | Private Endpoint provides secured, private connectivity to various Azure PaaS resources over bankbone Microsoft private network.|
