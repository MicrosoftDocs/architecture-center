...
description: Learn how to handle transient faults when connecting to remote and resources, caused by loss of network connectivity, temporary unavailability, or timeouts.
author: dragon119
ms.date: 07/13/2016
