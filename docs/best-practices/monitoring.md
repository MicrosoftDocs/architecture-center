...
- [Priority Queue pattern](../patterns/priority-queue.md) describes how to prioritize queued messages so that systems receive and process urgent requests before less urgent messages.
