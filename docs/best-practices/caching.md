...
description: Learn caching can improve the performance and scalability of a system by temporarily copying frequently accessed data to fast storage close to the application.
author: dragon119
ms.date: 05/24/2017
