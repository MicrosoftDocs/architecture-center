...
* **Azure appservice** has built-in autoscaling. Autoscale settings apply to all of the apps within an appservice. See [Scale instance count manually or automatically][app-service-autoscale].
...
* In an appservice Environment any worker pool or front-end metrics can be used to define autoscale rules. For more information, see [Autoscaling and appservice Environment](/azure/app-service/app-service-environment-auto-scale).
