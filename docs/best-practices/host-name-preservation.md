...
Similarly, when using Azure Spring Cloud, you can [use a custom domain for your app](/azure/spring-cloud/tutorial-custom-domain) to avoid use of the `azuremicroservices.io` host name.
