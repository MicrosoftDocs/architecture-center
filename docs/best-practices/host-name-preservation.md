...
:::image type="complex" source="images/host-name-preservation/platform-appservice.png" lightbox="images/host-name-preservation/platform-appservice.png" alt-text="Diagram that illustrates host-based routing in App Service." border="false":::
...
:::image type="content" source="images/host-name-preservation/configuration-host-overridden.png" lightbox="images/host-name-preservation/configuration-host-overridden.png" alt-text="Diagram that illustrates a configuration with the host name overridden." border="false":::
...
:::image type="complex" source="images/host-name-preservation/issue-absolute-urls.png" lightbox="images/host-name-preservation/issue-absolute-urls.png" alt-text="Diagram that illustrates the problem of incorrect absolute URLs." border="false":::
...
:::image type="complex" source="images/host-name-preservation/issue-redirect-urls.png" lightbox="images/host-name-preservation/issue-redirect-urls.png" alt-text="Diagram that illustrates the problem of incorrect redirect URLs." border="false":::
...
:::image type="complex" source="images/host-name-preservation/issue-cookies.png" lightbox="images/host-name-preservation/issue-cookies.png" alt-text="Diagram that illustrates an incorrect cookie domain." border="false":::
