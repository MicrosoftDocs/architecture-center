...
One common reason that an application server needs the host name is to construct absolute URLs and to issue cookies for a specific domain. For example, when the application code needs to:
