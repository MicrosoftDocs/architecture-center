...
| [Identity][Identity] | Use a managed identity provider (IdP) to provide the best security, reliability, and performance for the identity components of your solution. Avoid becoming the target of identity-based attacks and provide your users with modern identity features. | [Security][Overview of the security pillar], [Reliability][Principles of the reliability pillar], [Performance efficiency][Overview of the performance efficiency pillar] |
