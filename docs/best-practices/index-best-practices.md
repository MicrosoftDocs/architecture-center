...
:::row:::
   ...
   :::column span="3":::
      ...
      A key element of cloud applications is [data management][Data Management patterns]. Cloud systems can typically host data across multiple servers at separate locations. This approach can improve performance, scalability, and availability. But it can also present challenges. For example, to maintain data consistency, you often need to synchronize across different locations.
   :::column-end:::
:::row-end:::
:::row:::
   :::column span="1":::
   ...
   :::column span="3":::
      ...
      [Good design][Design and implementation patterns] involves many factors. One is consistency and coherence in component design and deployment. Another is design for easy maintenance. Reusability of components and subsystems is a third. Decisions that you make during design and implementation have a huge impact on the quality and cost of your cloud-hosted applications and services.
   :::column-end:::
:::row-end:::
:::row:::
   :::column span="1":::
...
This table lists various best practices. The **Category** column contains links to [Microsoft Azure Well-Architected Framework][Microsoft Azure Well-Architected Framework] pillars and development challenges that each practice addresses.
...
| [Data partitioning strategies][Data partitioning strategies] | Partition data in [Azure SQL Database][What is Azure SQL Database?] and [Azure Storage][Introduction to the core Azure Storage services] services like [Azure Table Storage][What is Azure Table storage?] and [Azure Blob Storage][Introduction to Azure Blob storage]. Shard your data to distribute loads, reduce latency, and support horizontal scaling. | [Data management][Data Management patterns], [Performance efficiency][Overview of the performance efficiency pillar], [Cost optimization][Principles of cost optimization] |
