...
description: Best practices for building reliable, scalable, secure applications in the cloud.
author: dragon119
ms.date: 03/01/2018
ms.topic: conceptual
...
These best practices are useful for building reliable, scalable, secure applications in the cloud.
...
| [Best practices for using content delivery networks (CDNs)][Best practices for using content delivery networks (CDNs)] | Load data on demand into a cache from a data store | [Data Management](./category/data-management.md), <hr> [Performance Efficiency](../framework/scalability/performance-efficiency-patterns.md) |
