...
This topic describes some general best practices and considerations when using a CDN. To learn more about using Azure CDN, see [CDN Documentation](/azure/cdn/).
...
* If the origin is Azure blob storage, add CORS rules to the storage endopint. For more information, see [Cross-Origin Resource Sharing (CORS) Support for the Azure Storage Services](http://msdn.microsoft.com/library/azure/dn535601.aspx).
