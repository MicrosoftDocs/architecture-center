...
Consider restricting the CDN content access by country/region. Azure CDN allows you to filter requests based on the country or region of origin and restrict the content delivered. For more information, see [Restrict access to your content by country/region](https://docs.microsoft.com/azure/cdn/cdn-restrict-access-by-country).
