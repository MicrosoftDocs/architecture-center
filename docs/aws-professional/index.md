...
| [Cost and Usage Reports](https://docs.aws.amazon.com/cur/latest/userguide/cur-create.html) | [Cost details APIs](/azure/cost-management-billing/manage/consumption-api-overview#cost-details-apis) <br/><br/>[Cost Management + Billing](/azure/cost-management-billing) | These services help you generate, monitor, forecast, and share billing data for resource usage by time, organization, or product resources. |
