...
[Azure Storage Standard Archive](https://docs.microsoft.com/en-us/azure/storage/blobs/storage-blob-storage-tiers) offers a direct equivalent to AWS' long-term archival
