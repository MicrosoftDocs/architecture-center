...
If you plan to migrate a workload from AWS to Azure, we suggest you have a methodical approach to that initiative. Component selection and Azure fundamentals are important parts of that larger process. Fine tune your migration plan using Microsoft's guidance, see [Migrate a workload from Amazon Web Services (AWS) to Azure](/azure/migration/migrate-workload-from-aws-introduction).
...
| [AWS Systems Manager](https://docs.aws.amazon.com/systems-manager/) | [Azure Automation](https://azure.microsoft.com/services/automation) <br/><br/>[Azure Update Manager](/azure/update-manager/overview) | Automation configures and operates applications of all shapes and sizes. It provides templates to create and manage a collection of resources. <br/><br/> Azure Update Manager is a service that helps manage updates for all your machines, including machines that run on Windows and Linux, across Azure, on-premises, and on other cloud platforms. You can use it to monitor update compliance from a single dashboard. You can make updates in real time, schedule updates within a maintenance window, or automatically make updates during off-peak hours. |
...
| [Amazon Data Firehose](https://aws.amazon.com/firehose/) and [Kinesis Data Streams](https://aws.amazon.com/kinesis/data-streams) | [Azure Event Hubs](https://azure.microsoft.com/services/event-hubs) <br/><br/>[Azure Stream Analytics](https://azure.microsoft.com/products/stream-analytics) <br/><br/>[Fabric Real-Time Intelligence](/fabric/real-time-intelligence) | These services facilitate the mass ingestion of events or messages, typically from devices and sensors. The data can then be processed in real-time microbatches or written to storage for further analysis. Both Kinesis Data Streams and Stream Analytics have real-time data processing capabilities.|
...
| [AWS IoT ExpressLink](https://aws.amazon.com/iot-expresslink/) | [Azure IoT Hub Device Provisioning Service](/azure/iot-dps/about-iot-dps) <br/><br/>[Azure SDK for Embedded C](https://azure.github.io/azure-sdk/releases/latest/c) | AWS IoT ExpressLink is connectivity software, plus a published command API, that powers Wi-Fi, cellular, and Bluetooth Low Energy (BLE) modules. These modules handle TLS, MQTT, and AWS IoT Core onboarding on behalf of a host microcontroller (MCU). Azure doesn't have a direct equivalent. Microcontroller-class devices [connect to Azure IoT Hub by using the Azure SDK for Embedded C](/azure/iot-hub/iot-sdks#embedded-device-sdks), with provisioning through the Device Provisioning Service. |
...
| [AWS Well-Architected Tool](https://docs.aws.amazon.com/wellarchitected/latest/userguide/intro.html) | [Azure Well-Architected Review](/assessments/azure-architecture-review/) | Examine your workload through the lenses of reliability, security, cost management, operational excellence, and performance efficiency. |
...
| [Cost and Usage Reports](https://docs.aws.amazon.com/cur/latest/userguide/cur-create.html) | [Cost details APIs](/azure/cost-management-billing/automate/automation-overview) <br/><br/>[Cost Management + Billing](/azure/cost-management-billing/) | These services help you generate, monitor, forecast, and share billing data for resource usage by time, organization, or product resources. |
| [AWS Management Console](https://aws.amazon.com/console) | [Azure portal](https://azure.microsoft.com/features/azure-portal) | The Azure portal is a unified management console that simplifies building, deploying, and operating your cloud resources. |
...
| [AWS Health Dashboard](https://aws.amazon.com/premiumsupport/technology/personal-health-dashboard) | [Azure Resource Health](/azure/service-health/resource-health-overview) | See detailed information about the health of resources. Get recommendations for how to maintain resource health. |
| [AWS CloudTrail](https://aws.amazon.com/cloudtrail) | [Activity log](/azure/azure-monitor/platform/activity-log) | The activity log is a platform log in Azure that provides insight into subscription-level events, like when a resource is modified or when a VM is started. |
| [AWS Config](https://aws.amazon.com/config) | [Azure Policy](/azure/governance/policy/overview)<br/><br/>[Change Analysis](/azure/governance/resource-graph/changes/resource-graph-changes) | Azure Policy helps you implement governance for resource consistency, regulatory compliance, security, cost, and management. Use Azure Policy for bulk remediation for existing resources and automatic remediation for new resources. You typically use AWS Config to monitor for configuration changes or to identify and remediate noncompliant resources.  |
...
| [AWS Control Tower](https://aws.amazon.com/controltower) | [Azure Lighthouse](/azure/lighthouse/overview)<br/><br/>[Azure landing zone](/azure/cloud-adoption-framework/ready/landing-zone/) | Set up and govern multiple-account or multiple-subscription environments.   |
...
| AWS service | Azure service | Description |
| :---------- | :------------ | :---------- |
| [Server-side encryption with AWS Key Management Service](https://docs.aws.amazon.com/kms/latest/developerguide/overview.html) | [Azure Storage service-side encryption](/azure/storage/common/storage-service-encryption) | Service-side encryption helps you protect your data and meet your organization's security and compliance commitments. |
| [AWS Key Management Service (KMS)](https://aws.amazon.com/kms), [AWS CloudHSM](https://aws.amazon.com/cloudhsm) | [Azure Key Vault](https://azure.microsoft.com/services/key-vault) <br/><br> [Azure Key Vault Managed HSM](/azure/key-vault/managed-hsm/overview) | These services improve security and enable you to work with other services by providing a way to manage, create, and control encryption keys that hardware security modules (HSMs) store. Key Vault provides a shared HSM or a dedicated HSM. On AWS, KMS uses a shared HSM. CloudHSM is a dedicated HSM. Both platforms provide Federal Information Processing Standards (FIPS)-validated options. |
...
| [AWS Shield](https://aws.amazon.com/shield) | [Azure DDoS Protection](/azure/ddos-protection/fundamental-best-practices) | These services help you protect your cloud services from distributed denial of service attacks. |
