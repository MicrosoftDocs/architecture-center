...
You must connect Microsoft Sentinel with AKS by using the [AKS connector](https://docs.azure.cn/en-us/sentinel/data-connectors/azure-kubernetes-service-aks). Then you can stream your AKS diagnostics logs into Microsoft Sentinel to continuously monitor activity in your instances.
