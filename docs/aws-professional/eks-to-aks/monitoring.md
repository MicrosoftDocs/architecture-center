...
Azure Managed Grafana is designed for the Azure environment, integrates with many Azure services, and includes built-in integration features. You can also deploy Grafana independently as a self-managed solution. For more information, see [Monitor your Azure services in Grafana](/azure/azure-monitor/visualize/grafana-plugin).
