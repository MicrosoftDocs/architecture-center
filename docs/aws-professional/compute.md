...
- [Baseline App Service web application with zone redundancy](../web-apps/app-services/architectures/baseline-zone-redundant.yml)
- [Active-passive multi-region App Service web application](../web-apps/app-services/architectures/multi-region.yml)
