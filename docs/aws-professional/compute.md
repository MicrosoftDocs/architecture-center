...
| [AWS Wavelength](https://aws.amazon.com/wavelength/) | [Azure Private MEC](https://learn.microsoft.com/azure/private-multi-access-edge-compute-mec/) / [Azure public MEC (Azure Edge Zones)](https://learn.microsoft.com/azure/extended-zones/overview) | Edge compute for 5G and ultra-low-latency mobile workloads, delivered in partnership with telecom carriers. |
