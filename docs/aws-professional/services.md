...
| [Cognito](https://aws.amazon.com/cognito/) | [Azure Active Directory](https://azure.microsoft.com/en-us/services/active-directory/) | Provides authentication capabilities for mobile applications. |
