...
| [Resource Groups & Tag Editor](https://docs.aws.amazon.com/ARG/)|[Resource Groups](/azure/azure-resource-manager/management/overview)  [& Tags](/azure/azure-resource-manager/management/tag-resources)| A Resource Group is a container that holds related resources for an Azure solution. Apply tags to your Azure resources to logically organize them by categories.|
