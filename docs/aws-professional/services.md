...
| AWS service | Azure service | Description |
| ----------- | ------------- | ----------- |
| Mobile Hub | [App Center](https://azure.microsoft.com/en-us/services/app-center/) <br/><br/>[Xamarin Apps](https://azure.microsoft.com/features/xamarin/) | Provides backend mobile services for rapid development of mobile solutions, identity management, data synchronization, and storage and notifications across devices. |
| Mobile SDK | [App Center](https://azure.microsoft.com/en-us/services/app-center/) | Provides the technology to rapidly build cross-platform and native apps for mobile devices. |
| Cognito | [App Center](https://azure.microsoft.com/en-us/services/app-center/) | Provides authentication capabilities for mobile applications. |
| AWS Device Farm | [App Center](https://azure.microsoft.com/en-us/services/app-center/) | Provides services to support testing mobile applications. |
| Mobile Analytics | [App Center](https://azure.microsoft.com/en-us/services/app-center/) | Supports monitoring, and feedback collection for the debugging and analysis of a mobile application service quality. |
