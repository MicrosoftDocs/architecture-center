...
| [Cloud Development Kit](https://aws.amazon.com/cdk) | [Azure Developer CLI](https://learn.microsoft.com/en-us/azure/developer/azure-developer-cli/) <br/><br/>[Azure Verified Modules](https://azure.github.io/Azure-Verified-Modules/) | Developer-friendly commands that enable consistent and repeatable work and standarized Infrastructure-as-Code samples.
