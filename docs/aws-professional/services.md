...
| [`eksctl`](https://docs.aws.amazon.com/eks/latest/userguide/getting-started-eksctl.html) | [az Azure Kubernetes Service (AKS)](/cli/azure/aks) command group | Manage Azure Kubernetes Service (AKS) using these Azure CLI commands. |
