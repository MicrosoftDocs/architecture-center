...
| [AWS Usage and Billing Report](https://docs.aws.amazon.com/cur/latest/userguide/cur-create.html) | [Azure Billing API](https://docs.microsoft.com/azure/billing/billing-usage-rate-card-overview) | Services that help generate, monitor, forecast, and share billing data for resource usage by time, organization, or product resources. |
