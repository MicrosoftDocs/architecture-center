...
| [`eksctl`](https://docs.aws.amazon.com/eks/latest/userguide/getting-started-eksctl.html) | [az Azure Kubernetes Service (AKS) command group](/cli/azure/aks) | Manage Azure Kubernetes Service (AKS) using these Azure CLI commands. |
