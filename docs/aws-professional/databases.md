...
| Data Warehouse | [Amazon Redshift](https://aws.amazon.com/redshift/) | [Microsoft Fabric Warehouse](/fabric/data-warehouse/data-warehousing) | Microsoft Fabric Warehouse is a lake-centric, distributed relational data warehouse that supports scalable SQL-based analytics and integrates tightly with Fabric workloads for unified analytics workflows. |
