...
- [Extend mainframes to digital channels by using standards-based REST APIs](./example-scenario/mainframe/extend-mainframes-rest-apis.yml)  ([#00d47173c8](https://github.com/MicrosoftDocs/architecture-center/commit/00d47173c8))
