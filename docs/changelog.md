...
- [IoT Edge railroad maintenance and safety system](./example-scenario/predictive-maintenance/iot-predictive-maintenance.yml)  ([#01eca30d6](https://github.com/MicrosoftDocs/architecture-center/commit/01eca30d6))
