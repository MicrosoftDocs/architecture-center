...
- [Azure Kubernetes Service (AKS) solution journey](/azure/architecture/reference-architectures/containers/aks-start-here)  ([#a45091c00](https://github.com/MicrosoftDocs/architecture-center/commit/a45091c00))
...
- [Back up files and applications on Azure Stack Hub](/azure/architecture/hybrid/azure-stack-backup)  ([#0673b82aa](https://github.com/MicrosoftDocs/architecture-center/commit/0673b82aa))
...
- [Disaster Recovery for Azure Stack Hub virtual machines](/azure/architecture/hybrid/azure-stack-vm-dr)  ([#44aec78f7](https://github.com/MicrosoftDocs/architecture-center/commit/44aec78f7))
