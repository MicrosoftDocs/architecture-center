---
title: Patterns for extending Azure Resource Manager template functionality - sequential looping
...
# Patterns for extending Azure Resource Manager template functionality - sequential looping
