...
The [Throttling pattern](./throttling.yml) is often enforced at the gatekeeper or gateway boundary, where centralizing rate state avoids the coordination cost of doing rate checks on every backend node.
