...
- The workload itself doesn’t have to be aware of the configuration system. This capability is a requirement if the source code of the workload isn't editable—for example, when using a module from the [Azure IoT Edge Marketplace](https://azuremarketplace.microsoft.com/marketplace/apps/category/internet-of-things?page=1&subcategories=iot-edge-modules).
