...
| ------- | ------- | -------- |
| [Ambassador](./ambassador.md) | Create helper services that send network requests on behalf of a consumer service or application. | [Design and Implementation](/azure/architecture/patterns/category/design-implementation), <br> [Management and Monitoring](/azure/architecture/patterns/category/management-monitoring) |
