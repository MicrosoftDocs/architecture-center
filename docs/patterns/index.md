...
| [Edge Workload Configuration](./edge-workload-configuration) | The great variety of systems and devices on the shop floor can make workload configuration a difficult problem. | [Design and Implementation](./category/design-implementation.md) |
...
| [Saga](../reference-architectures/saga/saga.yml) | It a way to manage data consistency across microservices in distributed transaction scenarios. A saga is a sequence of transactions that updates each service and publishes a message or event to trigger the next transaction step. |  [Messaging](./category/messaging.md) |
