...
In scenarios where your APIs can handle requests faster than throttled ingestion services allow, you must control how quickly you use the service. Treating throttling solely as a data rate mismatch and buffering requests until the service catches up is risky. If your application crashes in this scenario, any buffered data might be lost.
