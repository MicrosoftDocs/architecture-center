...
- Geode SAP Cache [Cache over SAP OData APIs](https://github.com/MartinPankraz/AzCosmosDB-OData-Shim) A sample OData API Geode set backed by Cosmos as a globally accelerated data cache for SAP Retail applications. 
