...
- **Scaling out subscribers.** If a given subscriber is unable to keep up with the rate of messages it receives, use the [Competing Consumers pattern](competing-consumers.md) to scale it out.
