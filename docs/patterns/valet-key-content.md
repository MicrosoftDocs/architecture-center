...
:::image type="complex" source="./_images/valet-key-pattern.png" lightbox="./_images/valet-key-pattern.png" alt-text="Diagram of a typical valet key pattern workflow.":::
