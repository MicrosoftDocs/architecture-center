...
> [!NOTE]
> The examples use Azure Managed Redis to access the store and retrieve information from the cache. For more information, see [Create an Azure Managed Redis instance](/azure/redis/quickstart-create-managed-redis) and [Use Azure Managed Redis in .NET](/azure/redis/dotnet).
