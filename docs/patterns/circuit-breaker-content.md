...
:::image type="complex" source="./_images/circuit-breaker-example.png" alt-text="Diagram that shows Azure Cosmos DB and a circuit breaker implementation in Azure App Service." border="false" lightbox="./_images/circuit-breaker-example.png":::
