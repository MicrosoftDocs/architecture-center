...
:::image type="icon" source="../_images/github.png"::: This sample is available on [GitHub](https://github.com/Azure-Samples/cloud-design-patterns/tree/main/async-request-reply).
