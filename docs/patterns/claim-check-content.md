...
|-------------------------------|------------------------------|-------------------------------|--------------------------------|--------------------|
| [Code example 1][example-1]   | Azure Queue Storage          | Azure Event Grid              | Executable command-line client | Azure Blob Storage |
| [Code example 2][example-2]   | Event Hubs (Standard API)    | Azure Event Grid              | Executable command-line client | Azure Blob Storage |
| [Code example 3][example-3]   | Azure Service Bus            | Azure Event Grid              | Executable command-line client | Azure Blob Storage |
