...
- [Command and Query Responsibility Segregation (CQRS) pattern](./cqrs-content.md). Use to update the information in a materialized view by responding to events that occur when the underlying data values change.
