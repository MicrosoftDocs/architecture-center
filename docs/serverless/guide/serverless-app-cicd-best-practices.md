...
[Compressing the files before serving](https://docs.microsoft.com/azure/cdn/cdn-improve-performance) improves file transfer speed and increases page-load performance for the end users. 
