...
For more information related to network security, reference [Securing Azure Functions](/azure-functions/security-concepts).
...
> - Use guidance available on [Securing Azure Functions](/azure-functions/security-concepts).
...
|Use guidance available on [Securing Azure Functions](/azure-functions/security-concepts).|This guidance addresses key security concerns such as operations, deployment, and network security.|
...
> [Azure Service Fabric and reliability](/framework/services/compute/azure-kubernetes-service/security.md)
