...
*Scalability* is the ability of a system to handle increased load and is one of the [pillars of the Azure architecture framework](../overview.md). Scalability tasks during the architecting phase include:
