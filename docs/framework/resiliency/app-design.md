...
- **Implement resiliency patterns** for remote operations, where appropriate. If your application depends on communication between remote services, follow [design patterns](azure/architecture/framework/resiliency/reliability-patterns.md) for dealing with transient failures.
