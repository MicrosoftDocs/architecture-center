...
For more information about using cloud services instead of custom implementations, reference [Applications and services](./design-apps-services.md#use-cloud-services-instead-of-custom-implementations).
