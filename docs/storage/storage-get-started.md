...
The articles in this section include fully developed architectures that you can deploy in Azure and expand to production-grade solutions and guides. These articles can help you decide how to use Storage technologies in Azure.
...
- [Azure files secured by AD DS](/azure/architecture/example-scenario/hybrid/azure-files-on-premises-authentication).  Implement on-premises access to Azure Files with Active Directory Domain Services authentication.
...
[Microsoft Learn](/training/?WT.mc_id=learnaka) provides free online training resources for Azure Storage technologies. The platform offers videos, tutorials, and hands-on labs for specific products and services.

The following resources provide foundational knowledge for Storage implementations on Azure organized by job role:
...
For guidance on migrating data to Azure Storage, see:
