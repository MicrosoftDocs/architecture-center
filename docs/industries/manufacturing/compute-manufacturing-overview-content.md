...
:::image type="content" source="./images/compute-manufacturing-overview/vm-sizes-inline.png" lightbox="./images/compute-manufacturing-overview/vm-sizes-expanded.png":::
