...
|[Agriculture](/azure/data-manager-for-agri/overview-azure-data-manager-for-agriculture?toc=/azure/architecture/toc.json&bc=/azure/architecture/_bread/toc.json)     |    Agriculture businesses can use Azure Data Manager for Agriculture Preview, built to help the industry accelerate their sustainability and agriculture practices using digital solutions.     |
