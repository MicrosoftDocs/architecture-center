...
|[Run CFD simulations](/azure/architecture/example-scenario/infrastructure/hpc-cfd)|Learn about running computational fluid dynamics (CFD) simulations by using Azure. Create, manage, and optimize clusters using by Azure CycleCloud. Applications for this architecture include the oil and gas industries.|Compute|
