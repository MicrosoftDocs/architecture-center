...
:::image type="content" alt-text="Architecture diagram showing an A I -enabled application that's running at the edge with Azure Stack Hub." source="../media/ai-at-the-edge.png" lightbox="../media/ai-at-the-edge.png":::
