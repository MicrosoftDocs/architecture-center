...
You're part of a central team of IaC developers that use a multicloud strategy for the fictional company Contoso. You want to deploy cloud infrastructure into a new Azure landing zone, using DevSecOps for IaC to ensure the security and quality of deployments. You also want to track and audit all modifications to the infrastructure.
...
1. With test driven development, you check in code changes for infrastructure definition, like IaC templates, into GitHub repositories. You develop unit tests, integration tests, and PaC at the same time to test the quality of IaC.
...
4. You configure GitHub Actions to scan for code quality and security issues. You then use security scanning tools built on GitHub's CodeQL to scan for security vulnerabilities on the IaC. If a vulnerability is detected, GitHub sends alerts to the organization or repository owners and maintainers.
...
- [Terraform](https://www.terraform.io) is a third-party product developed by HashiCorp that allows infrastructure automation on Azure and other environments.
...
- [Microsoft Sentinel](https://azure.microsoft.com/services/microsoft-sentinel) is a cloud-native Security Information and Event Management (SIEM) and security orchestration automated response (SOAR) solution. It uses advanced AI and security analytics to help you detect, hunt, prevent, and respond to threats across your enterprise.
