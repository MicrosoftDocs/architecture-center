...
- [Microsoft Entra ID](https://azure.microsoft.com/services/active-directory) is a identity and access management service that can synchronize with an on-premises directory.
