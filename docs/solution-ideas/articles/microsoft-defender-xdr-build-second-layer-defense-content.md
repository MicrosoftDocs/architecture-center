...
1. Security teams investigate and remediate the incident by using unified Defender XDR and Microsoft Sentinel workflows in the Microsoft Defender portal.
...
- [Microsoft Sentinel](/azure/sentinel/sentinel-overview) is a cloud-native SIEM and SOAR solution that's available in the Microsoft Defender portal as part of the unified security operations (SecOps) experience. In this architecture, it can integrate with Defender XDR to stream incidents and advanced hunting events for long-term retention, analytics, and orchestration.
