...
- [Microsoft Sentinel](/azure/sentinel/sentinel-overview) is a cloud-native SIEM and SOAR solution that's available in the Microsoft Defender portal as part of the unified SecOps experience. In this architecture, it aggregates Defender XDR incidents for long-term retention, advanced hunting, and orchestration.
