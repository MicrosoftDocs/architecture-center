...
:::image type="content" source="../media/enterprise-data-warehouse.png" alt-text="Diagram of a an enterprise data warehouse architecture using Azure Synapse Analytics with Azure Data Lake Storage Gen2, Azure Analysis Services and Power BI." border="false":::
