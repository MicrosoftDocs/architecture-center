...
1. Transfer files to Azure:
   ...
   - You can also find non-Microsoft tools in [Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace) to transfer files from mainframes to Azure.
