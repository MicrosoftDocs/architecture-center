...
- Integrated [geo-disaster recovery and geo-replication](https://docs.microsoft.com/azure/event-hubs/event-hubs-geo-dr). This integrated geo-disaster recovery is not available in most other offerings.
