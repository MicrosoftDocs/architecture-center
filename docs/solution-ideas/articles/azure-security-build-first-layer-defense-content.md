...
:::image type="complex" source="../media/azure-monitor-integrate-security-components-2.svg" alt-text="Diagram of Microsoft Zero Trust pillars mapped to Azure security controls and ATT&CK techniques." border="false" lightbox="../media/azure-monitor-integrate-security-components-2.svg"::: 
