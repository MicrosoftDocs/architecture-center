...
1. **Infrastructure and endpoints**
    ...
    | **Disk encrypt** | Encryption at host provides end-to-end encryption for VM data, including temp disks and disk caches. | [Encryption at host](/azure/virtual-machines/disk-encryption#encryption-at-host---end-to-end-encryption-for-your-vm-data) |
