...
2.  **NETWORK**
    ...
    | **AZURE FIREWALL** | A platform as a service (PaaS) that delivers protection in layer 4 and is attached to an entire VNET. | [What is Azure Firewall](/azure/firewall/overview)? |
