...
![Architecture diagram that shows how to develop and deploy models on an Azure data science virtual machine by using R.](../media/campaign-optimization-with-sql-server.svg)
