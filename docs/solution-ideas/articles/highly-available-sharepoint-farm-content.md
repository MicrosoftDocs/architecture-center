...
* [Azure Load Balancer](/azure/well-architected/service-guides/azure-load-balancer) is a layer-4 load balancing service that distributes network traffic across multiple resources. In this architecture, a public load balancer directs incoming HTTPS traffic to the SharePoint servers to ensure availability and performance.
