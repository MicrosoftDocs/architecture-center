...
This article provides guidance on monitoring serverless, event-driven architecture. 
...
This article uses Azure Monitor to provide monitoring of a serverless application built using Event Hubs and Azure Functions.
