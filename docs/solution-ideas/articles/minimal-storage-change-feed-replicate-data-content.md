...
1. Azure Cache for Redis caches database data for the functions. Using the cache offloads database activity and speeds up the function apps and web apps.
...
- Requires highly available data.
