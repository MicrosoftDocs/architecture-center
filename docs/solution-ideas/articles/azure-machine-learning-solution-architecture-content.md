...
> [!NOTE]
> The architecture described in this article is based on Azure Machinee Learning's CLI and Python SDK v1. For more information on the new v2 SDK and CLI, see [What is CLI and SDK v2](/azure/machine-learning/concept-v2).
