...
- [Face API](https://azure.microsoft.com/pricing/details/cognitive-services/face-api/) is AI service that analyzes faces in images. Face API is part of Cognitive Services.
