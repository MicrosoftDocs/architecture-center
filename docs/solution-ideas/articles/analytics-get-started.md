...
To learn how to choose the data store for your analytics solution, see the [Choose an analytical data store in Microsoft Fabric](../../data-guide/technology-choices/fabric-analytical-data-stores.md).
...
- [Choose an analytical data store in Microsoft Fabric](../../data-guide/technology-choices/fabric-analytical-data-stores.md) - Guidance on selecting the right analytical data store in Microsoft Fabric.
...
To get started, go to the [architectures](#architectures) section to find real-world solutions that you can build in Azure.
