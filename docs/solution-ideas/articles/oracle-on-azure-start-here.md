...
- [Oracle database migration: Lift and shift](/azure/virtual-machines/workloads/oracle/oracle-migration). If you're properly licensed to use Oracle software, you're allowed to migrate Oracle databases to Azure Virtual Machines (VMs).
