...
description: Big Data Analytics with Azure Data Explorer demonstrates big data analytics over large volumes of high velocity and wide variety of data.
author: orspod
ms.date: 08/11/2020
...
1. Data that is raw, structured, semi-structured, and unstructured (free text) such as logs, business events, and user activities can be ingested into Azure Data Explorer from various sources.
