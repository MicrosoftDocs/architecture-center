...
1. Raw, structured, semi-structured, and unstructured (free text) data such as logs, business events, and user activities can be ingested into Azure Data Explorer from various sources.
