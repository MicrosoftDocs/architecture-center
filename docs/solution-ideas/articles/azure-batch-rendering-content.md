...
:::image type="content" border="false" source="../media/azure-batch-rendering.svg" alt-text="Diagram that shows HPC media rendering solution architecture." lightbox="../media/zure-batch-rendering.svg":::
