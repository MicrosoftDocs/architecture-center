...
At the platform level, the following [big data best practices](../../guide/architecture-styles/big-data-content.yml#best-practices) contribute to trustworthy analytics on Azure:
