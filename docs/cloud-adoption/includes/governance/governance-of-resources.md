...
1. Establish a cloud DMZ.
    ...
    2. Validate that on-premises security and traffic management mechanisms are treat connected cloud networks as untrusted. Resources and services hosted in the cloud should only have access to authorized on-premises services.
