...
- **Recovery time triggers**. If a company exceeds the required thresholds for recovery time following a system failure, it should invest in improvement to its Deployment Acceleration discpline and systems design to reduce or eliminate failures or the impact of individual component downtime.
