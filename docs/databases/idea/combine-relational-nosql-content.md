...
:::image type="complex" source="images/combine-relational-nosql/scenario-diagram.svg" alt-text="Diagram that shows a client calling an API proxy that routes to two APIs and separate NoSQL and relational databases." border="false" lightbox="images/combine-relational-nosql/scenario-diagram.svg":::
...
*Download a [Visio file](https://arch-center.azureedge.net/solution-diagram-polyglot-persistence.vsdx) of this architecture.*
