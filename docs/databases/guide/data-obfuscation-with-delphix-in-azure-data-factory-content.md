...
1. Once all masking jobs complete successfully, Data Factory loads the masked data from Target Data Container to the specified destination.
...
- Other components might include various source and destination datastores depending on the specific use case. These components integrate into the architecture based on the data sources that you use, such as SAP, Salesforce, or Oracle EBS.
...
This solution uses Azure Data Factory data source connectors to create two ETL pipelines that automate the following steps:
...
- Provide production-grade data to your development and analytics pipelines, such as Azure DevOps, Jenkins, and Harness, and other automation workflows. To do so, mask sensitive data in centralized Azure Data Factory pipelines.
...
1. At the end of this step, masked data appears in the target datastore of your choice.
