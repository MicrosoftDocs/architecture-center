...
*Download a [Visio file](https://arch-center.azureedge.net/mongodb-atlas-single-region.vsdx) of the single-region architecture*
...
*Download a [Visio file](https://arch-center.azureedge.net/mongodb-atlas-multi-region.vsdx) of the multi-region architecture*
...
Depending on your use case and requirements, evaluate whether additional Microsoft security services are appropriate for your environment beyond those listed, such as Azure Firewall, Azure DDoS Protection, and Defender for Cloud. Depending on your architecture and threat model, you may also want to consider the following options:
