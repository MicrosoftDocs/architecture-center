...
To deploy CluedIn for development and evaluation purposes using Docker, see [CluedIn with Docker](https://www.cluedin.com/version.3.2).
...
- [CluedIn with Docker](https://www.cluedin.com/version.3.2)
