...
- [Design patterns](./patterns.yml): Apply proven design patterns to common microservices challenges, including the Saga pattern for distributed data consistency, the Bulkhead pattern for failure isolation, and the Strangler Fig pattern for incremental application refactoring.
