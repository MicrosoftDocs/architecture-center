...
The design patterns in this article address these challenges directly. Each pattern targets a specific concern that you might encounter as you design, build, and operate microservices.
