...
- The CI/CD process uses [Azure Pipelines](/azure/devops/pipelines/?view=azure-devops&preserve-view=true&preserve-view=true) to build, test, and deploy the microservices to AKS.
