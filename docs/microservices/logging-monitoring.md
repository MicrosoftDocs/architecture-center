...
- [Azure Data Explorer](https://docs.microsoft.com/azure/data-explorer/data-explorer-overview) is an Azure-native highly-scalable data exploration service for log and telemetry data with support for multiple data formats, a rich query language, and connections to consume data in popular tools like [Jupyter Notebooks](https://docs.microsoft.com/azure/data-explorer/kqlmagic) and [Grafana](https://docs.microsoft.com/azure/data-explorer/grafana). Azure Data Explorer has built-in connectors to ingest log and metrics data via Azure Event Hub. See [Ingest and query monitoring data in Azure Data Explorer](https://docs.microsoft.com/azure/data-explorer/ingest-data-no-code?tabs=diagnostic-metrics).
