...
- [SDK] (https://azure.microsoft.com/en-us/downloads/). The SDKs are collection of libraries that allows users to programmatically manage and interact with Azure services.
