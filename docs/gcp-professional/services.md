...
| Google Cloud service | Azure service | Description |
| --- | --- | --- |
| [Vertex AI](https://cloud.google.com/vertex-ai) | [Azure Machine Learning](https://azure.microsoft.com/services/machine-learning-services) | A cloud service to train, deploy, automate, and manage machine learning and GenAI models, with notebook, Designer, and automate options. |
...
| [Speech-to-Text](https://cloud.google.com/speech-to-text) | [Azure AI Services Speech To Text](https://azure.microsoft.com/services/cognitive-services/speech-to-text) | Quickly and accurately transcribe audio to text in more than 100 languages and variants. Customize models to enhance accuracy for domain-specific terminology. |
