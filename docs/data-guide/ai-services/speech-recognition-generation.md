...
| [Video avatar creation](/azure/ai-services/speech-service/text-to-speech-avatar/what-is-text-to-speech-avatar) | TTS avatar | Create lifelike and high-quality synthetic talking avatar videos for various real-time and batch applications while adhering to responsible AI practices. Avatar and video authoring is available in the Microsoft Foundry portal, including photo avatars created from a single input image (VASA-1). |
