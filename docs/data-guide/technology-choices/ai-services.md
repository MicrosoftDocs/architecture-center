...
| [Speech](https://azure.microsoft.com/products/ai-services/speech-services/) | [Azure AI Speech service capabilities guide ](../ai-services/speech-api.md) | Speech AI service is a service that provides speech capabilities like speech-to-text, text-to-speech, speech translation, and speaker recognition. |
