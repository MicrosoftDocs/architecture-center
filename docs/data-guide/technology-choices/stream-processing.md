...
- [Azure Databricks with Spark Structured Streaming](https://docs.azuredatabricks.net/user-guide/getting-started.html)
...
| | Azure Stream Analytics | HDInsight with Spark Streaming | Azure Databricks with Spark Structured Streaming | HDInsight with Storm | Azure Functions | Azure App Service WebJobs |
| --- | --- | --- | --- | --- | --- | 
...
| Pricing model | By streaming units | By cluster hour | By Databricks units | By cluster hour | Per function execution and resource consumption | Per app service plan hour |  
