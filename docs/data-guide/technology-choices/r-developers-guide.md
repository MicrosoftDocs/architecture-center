...
Customers currently using or evaluating Azure Machine Learning Studio (classic) are encouraged to try Azure Machine Learning studio, which provides drag-n-drop ML modules plus scalability, version control, and enterprise security.
