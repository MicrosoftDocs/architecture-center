...
**Considerations:** Horizontal scale generally requires [sharding](../../patterns/sharding.yml) or partitioning, and normalization can increase join cost for read-heavy denormalized views.
