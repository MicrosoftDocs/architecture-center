...
- [Azure DocumentDB](/azure/cosmos-db/mongodb/overview) is a globally distributed database that has MongoDB wire protocol compatibility and autoscaling.
...
| [Azure DocumentDB](/azure/cosmos-db/mongodb/overview) | Apps that use MongoDB drivers or JSON-centric APIs | Global distribution, autoscale, MongoDB-native wire protocol | Migrating a Node.js app from MongoDB to Azure |
