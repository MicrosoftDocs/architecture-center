...
description: Learn about data transfer options like the Azure Import/Export service, Azure Data Box, Fabric Data Factory, and command-line and graphical interface tools.
author: josearper
ms.author: joaria
ms.date: 10/04/2022
ms.topic: conceptual
