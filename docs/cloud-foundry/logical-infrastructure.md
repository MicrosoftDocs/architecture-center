...
Figure 5 shows a single PCF deployment in a single Azure Resource Group.
...
- **Four Azure Load Balancers (ALBs).** Load balancers are used as
    follows:
...
- **“Balance traffic across public cloud nodes and my datacenter.”**
