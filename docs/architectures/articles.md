            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Containers make it easy for you to continuously build and deploy applications. By orchestrating the deployment of those containers using Kubernetes in Azure Container Service, you can achieve replicable, manageable clusters of containers.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Data cache</h3>
                        <p>data cache, data cache with redis cache, azure database, cosmos db</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Messaging</h3>
                        <p>azure redis cache, web sockets, web communication frameworks, messaging publish and subscribe</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>scalable web apps, azure redis cache, session data cache, user cookie cache</p>
                    </div>
                </div>
            </div>
        </div>
