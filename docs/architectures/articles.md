        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/aircraft-engine-monitoring-for-predictive-maintenance-in-aerospace.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/anomaly-detection-in-real-time-data-streams.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/anomaly-detection-with-machine-learning.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/application-integration-using-event-grid.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/azure-devops-continuous-integration-and-continuous-deployment-for-azure-web-apps.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/azure-iot-subsystems.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/backup-archive-cloud-application.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/backup-archive-on-premises-applications.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/backup-archive-on-premises.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/big-compute-with-azure-batch.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/campaign-optimization-with-azure-hdinsight-spark-clusters.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/commerce-chatbot.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/container-cicd-using-jenkins-and-kubernetes-on-azure-container-service.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/cross-platform-chat.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/custom-mobile-workforce-app.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/customer-360.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
                        <h3>Customer 360</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/customer-churn-prediction.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/data-cache-with-redis-cache.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
                        <h3>Data cache</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/defect-prevention-with-predictive-maintenance.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/demand-forecasting-and-price-optimization.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/demand-forecasting.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/dev-test-image-factory.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/dev-test-microservice.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/dev-test-paas.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/digital-marketing-episerver.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/digital-marketing-sitecore.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/digital-marketing-smb.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/digital-marketing-using-azure-database-for-mysql.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/digital-marketing-using-azure-database-for-postgresql.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/disaster-recovery-enterprise-scale-dr.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/disaster-recovery-smb-azure-site-recovery.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/disaster-recovery-smb-double-take-dr.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/ecommerce-website-running-in-secured-ase.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/energy-supply-optimization.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/enterprise-productivity-chatbot.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/finance-management-apps-using-azure-database-for-mysql.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/finance-management-apps-using-azure-database-for-postgresql.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/forecast-energy-power-demand.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/gaming-using-azure-database-for-mysql.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/hpc-cluster.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/hybrid-ci-cd.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
                        <h3>Hybrid CI/CD</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/immutable-infrastructure-cicd-using-jenkins-and-terraform-on-azure-virtual-architecture-overview.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/information-chatbot.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/information-discovery-with-deep-learning-and-nlp.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/instant-broadcasting-on-serverless-architecture.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/intelligent-apps-using-azure-database-for-mysql.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/interactive-querying-with-hdinsight.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/interactive-voice-response-bot.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/iot-devices.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
                        <h3>IoT devices</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/iot-using-cosmos-db.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/iot-with-aks.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/java-cicd-using-jenkins-and-azure-web-apps.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/loan-chargeoff-prediction-with-azure-hdinsight-spark-clusters.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/medical-data-storage.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/medium-umbraco-web-app.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/messaging.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
                        <h3>Messaging</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/microservices-with-aks.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/migrate-existing-applications-with-aks.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/modern-customer-support-portal-powered-by-an-agile-business-process.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
                        <h3>Lift and Shift and Innovate - LOB Apps</h3>
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/modern-data-warehouse.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/oil-and-gas-tank-level-forecasting.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/onboarding-customers-with-a-cloud-native-serverless-architecture.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/personalization-using-cosmos-db.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/personalized-marketing.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/personalized-offers.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/population-health-management-for-healthcare.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/predictive-insights-with-vehicle-telematics.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/predictive-marketing-campaigns-with-machine-learning-and-spark.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/quality-assurance.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/real-time-analytics.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/real-time-web-dashboard.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/remote-patient-monitoring.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/retail-and-e-commerce-using-cosmos-db.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/retail-and-ecommerce-using-azure-database-for-mysql.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/retail-and-ecommerce-using-azure-database-for-postgresql.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/retail-assistant-or-vacation-planner-with-visual-capabilities.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/sap-netweaver-on-sql-server.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/sap-s4-hana-on-hli-with-ha-and-dr.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/sap-s4-hana-vm-on-linux.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/scalable-ecommerce-web-app.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/scalable-web-and-mobile-applications-using-azure-database-for-mysql.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/scalable-web-apps.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
        ...
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/scale-using-aks-with-aci.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/security-compliance-blueprint-hippa-hitrust-health-data-ai.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/security-compliance-blueprint-hippa-hitrust-health-data-ai.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
                        <h3>Medical Data Storage Solutions</h3>
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/serverless-application-architectures-using-event-grid.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/serverless-application-architectures-using-event-grid.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/serverless-apps-using-cosmos-db.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/serverless-apps-using-cosmos-db.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/simple-branded-website.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/simple-branded-website.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/social-mobile-and-web-app-with-authentication.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/social-mobile-and-web-app-with-authentication.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/streaming-using-hdinsight.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/streaming-using-hdinsight.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/subsystems-and-crosscutting.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/subsystems-and-crosscutting.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
                        <h3>IoT Architecture  Azure IoT Subsystems</h3>
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/supply-chain-track-and-trace.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/supply-chain-track-and-trace.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/task-based-consumer-mobile-app.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/task-based-consumer-mobile-app.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/telemetry-analytics.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/telemetry-analytics.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
...
<li style="display: flex; flex-direction: column;">
    <a href="./articles/visual-assistant.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                        <div class="cardImage">
                            <img src="./articles/media/visual-assistant.svg" height="140px" />
                        </div>
                    </div>
                    <div class="cardText">
