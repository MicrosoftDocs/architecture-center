...
* The implemented algorithm is hybrid quantum-classical by nature (for example, Variational Quantum Eigensolvers (VQE), Quantum Approximate Optimization Algorithms (QAOA), ...).
