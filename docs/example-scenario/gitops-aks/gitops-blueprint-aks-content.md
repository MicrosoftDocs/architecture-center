...
Two GitOps operators that you can use with AKS are [Flux](https://fluxcd.io) and [Argo CD](https://argo-cd.readthedocs.io). They both were [Cloud Native Computing Foundation (CNCF)](https://www.cncf.io) projects and are widely used. The following scenarios show ways to use them.
