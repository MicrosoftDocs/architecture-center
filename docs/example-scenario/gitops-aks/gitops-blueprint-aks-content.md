...
- Flux v2 supports multi-tenancy. Multiple Git repositories can be synchronized to the cluster. Also, Flux can use one cluster to manage the apps in either same or other clusters.
