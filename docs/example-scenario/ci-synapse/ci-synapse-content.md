Dynamics Customer Insights (CI) can create a 360-degree customer view by unifying data from transactional, behavioral, and observational sources. You can them make this 360-degree customer view available inside enterprise data lakes and/or data warehouses as a golden customer dimension. 
