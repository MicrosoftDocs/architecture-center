...
**Generation 2 (Gen2) virtual machines.** When you deploy VMs in Azure, you can choose generation 1 or generation 2. [Generation 2 VMs](/azure/virtual-machines/generation-2) support features that aren't available in generation 1.  
