...
**Load balancers.** An internal [Azure Load Balancer](/azure/well-architected/service-guides/azure-load-balancer/reliability) is used to distribute traffic to virtual machines in the SAP subnets. Azure Load Balancer supports zone-redundant distribution for zonal deployments of SAP.
