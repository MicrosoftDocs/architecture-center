...
As Azure NetApp Files continuously evolves – adding capabilities to optimize cost, boost agility, and enable AI-driven experiences across product and engineering data – these innovations build on the core availability, performance, and data protection foundations of this architecture.

**Enabling AI integrations over PLM and PDM data.** As organizations explore AI-assisted workflows in engineering and manufacturing, Teamcenter environments contain rich product data, including CAD files, specifications, bills of materials, and engineering documentation. When PLM data is stored on Azure NetApp Files, organizations can build AI integrations that access data in place – leveraging the Azure NetApp Files object [REST API](/azure/azure-netapp-files/object-rest-api-introduction) – without duplicating or re-architecting storage. Common patterns include AI-assisted search and discovery across engineering documents, retrieval-augmented generation (RAG) scenarios grounded in authoritative PLM and PDM content, and integration with enterprise AI services and workflows governed by existing access controls and security policies.
