...
**Use the Azure calculator.** The Azure calculator can help you estimate and optimize cost. For an estimated cost of the baseline architecture, see [preconfigured estimate in the Azure pricing calculator](https://azure.com/e/f832a334f77c4418b2ad17a196e66f34). Your estimates might differ based on your Teamcenter implementation in Azure. The estimate excludes Azure Firewall and Azure Bastion because those are shared hub infrastructure resources that the platform team typically manages and budgets separately. The estimate also excludes all non-Microsoft licensing.
