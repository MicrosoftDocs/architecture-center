...
- Specific business requirements for your analytics use cases might also ask for the use of different services or features not considered in this design.
