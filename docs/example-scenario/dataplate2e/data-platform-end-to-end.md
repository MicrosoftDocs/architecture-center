...
- For situations where device management, authentication, and provisioning are required, [Azure IOT Hub](/azure/iot-hub/) may be a preferred solution over Event Hub.  Event hub should still be considrered for other streaming data sources.
