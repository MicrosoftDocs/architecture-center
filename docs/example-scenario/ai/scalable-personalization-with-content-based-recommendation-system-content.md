...
Collaborative filtering: Collaborative filtering identifies similar patterns in customer behavior and recommends items that other similar customers have interacted with. The best advantage of following the collaborative filtering approach is the data generation - users create data while interacting with the items/ products. Moreover, the customers could discover new items/ products outside of recommendation space curated from their historical profile. However, collaborative filtering approach faces the cold start problem. Since there is a scarcity of user-new product interaction, introducing new products to the system is difficult. 
