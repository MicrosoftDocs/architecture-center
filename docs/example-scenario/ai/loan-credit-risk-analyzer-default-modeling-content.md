...
3. Processing: Azure Machine Learning is used to develop and manage the machine learning models.
    ...
    1. Responsible AI: Responsible AI is an approach to developing, assessing, and deploying AI systems in a safe, trustworthy, and ethical way. Because this model infers an approval or denial decision for a loan request, you need to implement the principles of Responsible AI.
