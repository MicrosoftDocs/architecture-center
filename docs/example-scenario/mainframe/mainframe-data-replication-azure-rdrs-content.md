...
- [Azure SQL](/azure/azure-sql/azure-sql-iaas-vs-paas-what-is-overview) is a family of fully managed services based on SQL Server technology. You can migrate relational data and use it efficiently with other Azure components, including Azure SQL Managed Instance, Azure SQL Database, and SQL Server on Azure VMs, along with integration options like Azure Database for PostgreSQL and Azure Database for MySQL. In this architecture, Azure SQL serves as one of the target platforms for mainframe data replication and supports both real-time CDC and bulk-load operations.
