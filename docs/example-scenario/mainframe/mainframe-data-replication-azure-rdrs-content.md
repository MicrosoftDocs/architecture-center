...
:::image type="complex" border="false" source="./media/mainframe-realtime-batch-data-replication-azure-rdrs.svg" alt-text="Architecture diagram of the data flow that shows how to migrate a mainframe to the Azure data platform." lightbox="./media/mainframe-realtime-batch-data-replication-azure-rdrs.svg":::
