...
- Scale, pause, and resume compute resources by using [Azure SQL Database serverless](https://azure.microsoft.com/products/azure-sql/database), which automatically adjusts based on workload activity so that you pay only for what you use.
