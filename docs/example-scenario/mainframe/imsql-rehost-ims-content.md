...
- [Azure SQL Managed Instance](/azure/well-architected/service-guides/azure-sql-managed-instance/reliability) is a managed, highly secure, always up-to-date SQL instance in the cloud that's part of the Azure SQL service portfolio. In this architecture, SQL Managed Instance serves as the robust database platform for IMSql. It replaces the mainframe IMS database system and provides the storage and transaction processing capabilities.
...
- [Azure Virtual Network](/azure/well-architected/service-guides/virtual-network) is the fundamental building block for your private network in Azure. It enables many types of Azure resources, like VMs, to communicate with each other, the internet, and on-premises networks, all with improved security. In this architecture, Virtual Network provides the networking foundation and secure communication infrastructure for all IMSql components.
