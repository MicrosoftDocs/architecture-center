...
:::image type="content" source="media/asysco-zos-migration.svg" alt-text="Diagram showing how Avanade AMT migration maps z/OS mainframe components to Azure capabilities." lightbox="media/asysco-zos-migration.svg" border="false":::
