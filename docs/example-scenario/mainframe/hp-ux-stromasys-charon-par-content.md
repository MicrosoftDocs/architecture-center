...
- [Azure Managed Disks](/azure/virtual-machines/managed-disks-overview) are block-level storage volumes managed by Azure that are used with Azure VMs. Ultra Disks, Premium SSDs, Standard SSDs, and Standard HDDs are available. For this architecture, we recommend either Premium SSDs or Ultra Disks.
...
This solution works best with Premium SSDs or Ultra Disks. We recommend Premium SSDs. Ultra Disks are an option for even higher input/output operations per second (IOPS).
