...
For more information about WordPress security, see [General WordPress security](./wordpress-overview-content.md#general-wordpress-security-and-performance-tips) and [Azure Security Documentation][security].
