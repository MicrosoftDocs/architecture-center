...
:::image type="content" alt-text="Diagram showing the architecture of a computational-fluid-dynamics scenario." source="./media/architecture-hpc-cfd.svg" lightbox="./media/architecture-hpc-cfd.svg":::
