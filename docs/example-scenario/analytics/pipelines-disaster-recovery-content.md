...
In Data Factory, you can set the Azure integration runtime (IR) region for your activity execution or dispatch in the **Integration runtime setup**. To enable automatic failover in the event of an Azure region going down, set the **Region** to **Auto Resolve**.
