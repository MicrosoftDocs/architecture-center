...
## Architecture
![Diagram of a solution that ingests data from multiple sources and uses machine learning to optimize inventory and forecast demand.](media/optimize-inventory-forecast-demand-architecture.svg#lightbox)
...
![Diagram of the components that ingest sales history and produce demand predictions in this example workload.](media/optimize-inventory-forecast-demand-dataflow.svg#lightbox)
