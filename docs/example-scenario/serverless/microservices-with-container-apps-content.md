...
- Review an example price estimate for the workload. Use the [Azure pricing estimate](https://azure.com/e/4f044f65e46f40c7a9d7a4837a17e6d7). Configurations vary, so adjust it to match your scenario.
