...
[Azure DDoS Protection Standard](azure/ddos-protection/ddos-protection-overview), combined with application design best practices, provides enhanced DDoS mitigation features to defend against DDoS attacks. [Azure DDOS Protection Standard](/azure/ddos-protection/ddos-protection-overview) should be enabled on any perimeter virtual network hosting for better protection.
