...
A modern data warehouse (MDW) lets you easily bring all of your data together at any scale. It doesn't matter if it's  structured, unstructured, or semi-structured data (logs, files, and media). You can gain insights to an MDW through analytical dashboards, operational reports, or advanced analytics for all your users.
...
This article will describe how a fictional city planning office could use this solution. The solution provides an end-to-end data pipeline that follows the MDW architectural pattern, along with corresponding DevOps and DataOps processes, to assess parking use and make more informed business decisions.
...
* Support for both row-level and object-level security:
  ...
  * You can also find it in SQL Data Warehouse (SQLDW), Azure Analysis Services (AAS) and Power BI.
...
These components used in the solution:
...
1. **Carry out an initial Build and Release**: Create a sample change in Data Factory (for example, enabling schedule trigger) then watch the change automatically get deployed across environments.
...
For more information, read the [Build and Release Pipeline](https://github.com/Azure-Samples/modern-data-warehouse-dataops/tree/master/e2e_samples/parking_sensors#build-and-release-pipeline) section of the docs.

### Testing

The solution includes support for both unit testing and integration testing. It uses pytest-adf and the Nutter Testing Framework. For more information, see the [Testing](https://github.com/Azure-Samples/modern-data-warehouse-dataops/tree/master/e2e_samples/parking_sensors#testing) section of the docs for the parking sensor solution example.

### Observability and Monitoring

The solution support Observability and Monitoring for Databricks and Data Factory. For more information, see the [Observability/Monitoring](https://github.com/Azure-Samples/modern-data-warehouse-dataops/tree/master/e2e_samples/parking_sensors#observability--monitoring) section of the docs.
