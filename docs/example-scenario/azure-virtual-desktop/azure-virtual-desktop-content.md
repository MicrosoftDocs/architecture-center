...
> [!NOTE]
> Persistent and Non-persistent terminology in this case is in reference to the persistence of the user profile. It does not imply that the operating system disk resets with a reference or golden image and/or discards changes on reboot.
