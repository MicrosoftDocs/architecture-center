...
# Architecture
The following sections present best practice recommendations and options for customers with huge number of IPv4 address requirement or the ones who are running out of RFC 1918 address space. Each recommendation is collated under the "Best Practices" section.
