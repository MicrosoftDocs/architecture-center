...
- [Azure Virtual Network](/azure/well-architected/service-guides/virtual-network) enables you to create your own private network infrastructure in the cloud.
