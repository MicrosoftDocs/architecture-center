...
Many technology options are available for real-time message ingestion, data storage, stream processing, storage of analytical data, and analytics and reporting. For an overview of these options, their capabilities, and key selection criteria, see [Big data architectures: Real-time processing](../../data-guide/technology-choices/real-time-ingestion.md) in the [Azure Data Architecture Guide](../../data-guide/index.yml).
...
- [Real time processing architecture](../../data-guide/big-data/real-time-processing.md) in the [Azure Data Architecture Guide](../../data-guide/index.yml).
...
[availability]: ../../framework/resiliency/overview.yml
[scalability]: ../../framework/scalability/performance-efficiency.yml
[resiliency]: ../../patterns/category/resiliency.yml
