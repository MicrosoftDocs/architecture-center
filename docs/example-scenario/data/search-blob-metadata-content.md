...
You can achieve this by using [multiple indexers](/azure/search/search-indexer-overview#indexer-scenarios-and-use-cases) in [Azure Cognitive Search](/azure/search/search-what-is-azure-search). In this example scenario we create a single [search index](/azure/search/search-what-is-an-index) from files in [Blob storage](/azure/storage/blobs/storage-blobs-overview), with their metadata stored in [Table storage](/azure/storage/tables/table-storage-overview).
...
### Searching through file metadata
