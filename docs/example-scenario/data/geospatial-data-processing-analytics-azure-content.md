...
:::image type="content" source="./media/geospatial-data-processing-analytics-azure-architecture-thumbnail-new.svg" alt-text="Architecture diagram showing how geospatial data flows through an Azure system. Various components receive, process, store, analyze, and publish the data." lightbox="./media/geospatial-data-processing-analytics-azure-architecture-thumbnail-new.svg":::
