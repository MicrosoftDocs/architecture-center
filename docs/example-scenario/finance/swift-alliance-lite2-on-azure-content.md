...
We recommend that you deploy SWIFT components in a subscription that doesn't contain any back-office applications. Use a separate subscription to ensure that SWIFT CSP-CSCF applies only to SWIFT components and not to your other components.
