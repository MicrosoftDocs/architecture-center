...
> [!NOTE]
> The recommendation in Azure Virtual Desktop is to use Profile Container without Office Container, unless you are planning for specific business continuity and disaster recovery (BCDR) scenarios, as described in this [section](/azure/databricks/administration-guide/disaster-recovery).
