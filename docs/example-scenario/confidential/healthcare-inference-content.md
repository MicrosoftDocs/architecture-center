...
- You can use [Occulum](https://occlum.io/) instead of SCONE to run within the AKS cluster that has SGX enabled. Occulum enables legacy applications to run with little to no modifications in an isolated environment.
