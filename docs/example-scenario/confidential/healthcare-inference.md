...
:::image type="complex" source="./media/healthcare-demo-architecture.png" alt-text="Diagram of a confidential healthcare platform demonstration. The platform includes a hospital, medical platform provider, and diagnostic provider.":::
