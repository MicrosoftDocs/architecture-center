...
- **Service Bus** Premium supports [geo replication](/service-bus-messaging/service-bus-geo-replication) and Service Bus Standard supports active and passive [replication](/azure/service-bus-messaging/service-bus-outages-disasters#protection-against-outages-and-disasters).
