...
- [A code-centric tutorial showing the use of messaging for integrating with 3rd party systems - using NServiceBus](https://docs.particular.net/tutorials/nservicebus-sagas/3-integration/)
