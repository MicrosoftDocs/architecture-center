...
- **Dynamics365 Sales Insights**. [Sales Insights](https://docs.microsoft.com/en-us/dynamics365/ai/sales/overview) is a Dynamics 365 add-in that analyzes data in the Dataverse to provide sophisticated insights. This solution uses Sales Insights for:
