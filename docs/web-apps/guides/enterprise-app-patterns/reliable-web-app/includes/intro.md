...
| Benefits | Code updates | Architecture updates | Configuration updates |
|----------|--------------|--------------|---------------|
| Cloud-optimized web app <br> High-value updates <br>Minimal code changes <br>Identity-centric security <br>Secure network perimeter | Retry pattern<br>Circuit-breaker pattern<br>Cache-aside pattern | PaaS solutions<br>Network perimeter<br>Network topology<br>Redundancy<br>Private endpoints<br>Web application firewall | <br>Role-based access control<br>Managed identities<br>Infrastructure as code<br>Rightsized environments
