...
- *Perform security scans.* Use static application security testing (SAST) to find security flaws and coding errors in your source code. Conduct software composition analysis (SCA) to examine non-Microsoft libraries and components for security risks. Tools for these analyses are easy to integrate into both GitHub and Azure DevOps.
