...
- [Azure App Service landing zone](/azure/cloud-adoption-framework/scenarios/app-platform/app-services/landing-zone-accelerator) guidance in the Cloud Adoption Framework provides recommendations for hardening and scaling App Service deployments.
