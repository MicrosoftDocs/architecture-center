...
For more information about authentication and authorization in this application, see the [Security considerations](./web-app.yml#security) section of the reference architecture.
