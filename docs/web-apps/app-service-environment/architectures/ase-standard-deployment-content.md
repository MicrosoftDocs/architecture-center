...
To learn how to extend this architecture to support high availability, read [High availability app deployment using App Service Environment](./app-service-environment-high-availability-deployment.yml).
