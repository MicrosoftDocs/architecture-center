...
- [Baseline Foundry chat reference architecture](./architecture/baseline-microsoft-foundry-chat.yml) describes how to build an end-to-end chat architecture by using Azure OpenAI in Foundry Models. It incorporates grounding via enterprise data sources to enrich responses with contextual information.
