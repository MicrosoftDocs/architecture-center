...
- [Speech to text models](/azure/foundry/foundry-models/concepts/models-sold-directly-by-azure?tabs=global-standard-aoai%2Cglobal-standard&pivots=azure-openai#speech-to-text-models) in the family of [GPT audio models](/azure/foundry/foundry-models/concepts/models-sold-directly-by-azure?tabs=global-standard-aoai%2Cglobal-standard&pivots=azure-openai#speech-to-text-models) can be used for transcript generation from the audio, persist to Azure blob storage for call analytics.
