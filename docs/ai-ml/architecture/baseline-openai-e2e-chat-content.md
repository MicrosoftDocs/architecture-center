...
- **Set hard limits.** Use the token limits per model to set absolute spend thresholds. For models that aren't expected to be used set a token limit of 0. This will effectively cap the amount of spend possible within the service.
