...
1. Orchestrators like Azure Logic Apps, Azure Data Factory, or Azure Functions ingest messages and attachments from email servers, and files from File Transfer Protocol (FTP) servers or web applications.
...
1. Azure AI Document Intelligence Studio, Language Studio, or Azure Machine Learning studio label and tag textual data and build the custom models. You can use these three services independently or in various combinations to address different use cases.

   - If the document requires extracting key-value pairs or creating a custom table from an image format or PDF, use Azure AI Document Intelligence Studio to tag the data and train the custom model.
...
1. To deploy the custom models and use them for inference:
   ...
   - Azure AI Document Intelligence has built-in model deployment. [Use Azure AI Document Intelligence SDKs or the REST API](/azure/applied-ai-services/form-recognizer/how-to-guides/use-sdk-rest-api) to apply custom models for inferencing. Include the [model ID](https://westus.dev.cognitive.microsoft.com/docs/services/form-recognizer-api-v2-1/operations/AnalyzeWithCustomForm) or [custom model name](https://westus.dev.cognitive.microsoft.com/docs/services/form-recognizer-api-v3-0-preview-2/operations/AnalyzeDocument) in the Azure AI Document Intelligence request URL, depending on the API version. Azure AI Document Intelligence doesn't require any further deployment steps.
...
- [Azure AI Document Intelligence](https://azure.microsoft.com/services/form-recognizer), part of [Azure AI services](https://azure.microsoft.com/solutions/ai/applied-ai-services), has in-built document analysis capabilities to extract printed and handwritten text, tables, and key-value pairs. Azure AI Document Intelligence has prebuilt models for extracting data from invoices, documents, receipts, ID cards, and business cards. Azure AI Document Intelligence can also train and deploy custom models by using either a [custom template](/azure/applied-ai-services/form-recognizer/concept-custom-template) form model or a [custom neural](/azure/applied-ai-services/form-recognizer/concept-custom-neural) document model.

  [Azure AI Document Intelligence Studio](https://formrecognizer.appliedai.azure.com) provides a UI for exploring Azure AI Document Intelligence features and models, and for building, tagging, training, and deploying custom models.

- [AI Language](https://azure.microsoft.com/services/cognitive-services/language-service) consolidates the Azure natural language processing (NLP) services. The suite offers prebuilt and customizable options. For more information, see the Azure AI Language [available features](/azure/cognitive-services/language-service/overview#available-features).

  [Language Studio](https://aka.ms/languageStudio) provides a UI for exploring and analyzing AI Language features. Language Studio also provides options for building, tagging, training, and deploying custom models.
...
- If the document is in image or PDF format, you can extract the data by using Azure [Computer Vision](/azure/cognitive-services/computer-vision/overview-ocr), [Azure AI Document Intelligence Read API](/azure/applied-ai-services/form-recognizer/how-to-guides/use-prebuilt-read?pivots=programming-language-python), or open-source libraries.

- You can do [document and conversation summarization](/azure/cognitive-services/language-service/text-summarization/overview) by using the prebuilt model in AI Language.
...
Document processing is a broad area. It can be difficult to meet all your document processing needs with the prebuilt models available in AI Document Intelligence and AI Language. You might need to build custom models to automate document processing for different applications and domains.
...
- See the availability service-level agreements (SLAs) for each component Azure service:
  ...
  - AI Document Intelligence - [SLA for Azure AI services](https://azure.microsoft.com/support/legal/sla/azure-applied-ai-services/v1_0).
  - AI Language - [SLA for Azure AI services](https://azure.microsoft.com/support/legal/sla/cognitive-services/v1_1).
...
- For Azure AI Document Intelligence, [back up and recover your Azure AI Document Intelligence models](/azure/applied-ai-services/form-recognizer/disaster-recovery).
...
- Implement data protection, identity and access management, and network security recommendations for [Blob Storage](/azure/storage/blobs/security-recommendations), [Azure AI services](/security/benchmark/azure/baselines/cognitive-services-security-baseline) for Azure AI Document Intelligence and Language Studio, and [Azure Machine Learning](/security/benchmark/azure/baselines/machine-learning-security-baseline).
...
- [AI Document Intelligence pricing](https://azure.microsoft.com/pricing/details/form-recognizer)
...
- Azure AI Document Intelligence supports 15 concurrent requests per second by default. To request an increased quota, [create an Azure Support ticket](/azure/azure-portal/supportability/how-to-create-azure-support-request).
...
- [Get started: Azure AI Document Intelligence Studio](/azure/ai-services/document-intelligence/quickstarts/try-document-intelligence-studio?view=doc-intel-3.1.0)
- [Use Azure AI Document Intelligence SDKs or REST API](/azure/applied-ai-services/form-recognizer/how-to-guides/use-sdk-rest-api)
