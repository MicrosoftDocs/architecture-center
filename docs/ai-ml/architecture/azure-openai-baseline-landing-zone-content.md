...
:::image type="complex" source="./_images/azure-openai-baseline-landing-zone.svg" border="false" lightbox="./_images/azure-openai-baseline-landing-zone.svg" alt-text="Architecture diagram of the workload, including select platform subscription resources.":::
...
:::image type="complex" source="./_images/azure-openai-baseline-landing-zone-networking.svg" border="false" lightbox="./_images/azure-openai-baseline-landing-zone-networking.svg" alt-text="Architecture diagram that focuses mostly on network ingress flows.":::
...
:::image type="complex" source="./_images/azure-openai-baseline-landing-zone-networking-egress.svg" border="false" lightbox="./_images/azure-openai-baseline-landing-zone-networking-egress.svg" alt-text="Architecture diagram that focuses mostly on network egress flows.":::
