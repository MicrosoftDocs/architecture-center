...
- Azure Web Application Firewall helps protect your application from common vulnerabilities. This Application Gateway option uses Open Worldwide Application Security Project (Open Web Application Security Project (OWASP)) rules to prevent attacks like cross-site scripting, session hijacks, and other exploits.
