...
- [Azure Data Factory](https://azure.microsoft.com/products/data-factory) is a fully managed serverless data integration service that helps you construct extract, transform, load (extract, transform, and load (ETL)) and extract, load, transform (extract, load, and transform (ELT)) processes.
