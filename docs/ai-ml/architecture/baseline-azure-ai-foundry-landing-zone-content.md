...
- **Policy:** *Foundry models should not be preview.*
  ...
  **Complication:** You might be in development by using a preview model, which you expect might be generally available by the time you enable the agent capability in your production workload.
