...
:::image type="content" source="_images/autonomous-driving-development-lifecycle.png" alt-text="Diagram that shows the autonomous driving development lifecycle." lightbox="_images/autonomous-driving-development-lifecycle.png" border="false":::
...
:::image type="content" source="_images/avops-design.png" alt-text="Diagram that shows the elements of an AVOps architecture." lightbox="_images/avops-design.png" border="false":::
...
> [Solution idea for AVOps solution](../architecture/avops-architecture.yml)
