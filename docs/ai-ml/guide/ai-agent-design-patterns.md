...
:::image type="complex" border="false" source="_images/group-chat-pattern.svg" alt-text="Diagram that shows group chat orchestration where multiple agents participate in a managed conversation. A central chat manager coordinates the discussion flow.":::
...
:::image type="complex" border="false" source="_images/group-chat-pattern-example.svg" alt-text="Diagram that shows group chat orchestration for municipal park planning with specialist city planning agents.":::
...
:::image type="complex" border="false" source="_images/magentic-pattern.svg" alt-text="Diagram that shows magentic orchestration.":::
...
:::image type="complex" border="false" source="_images/magentic-pattern-example.svg" alt-text="Diagram that shows magentic orchestration for SRE automation.":::
