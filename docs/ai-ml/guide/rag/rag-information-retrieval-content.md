...
> [!IMPORTANT]
> Before you embed the query, you should perform the same [cleaning operations](./rag-enrichment-phase.yml#cleaning) that you performed on chunks. For example, if you lowercased every word in your embedded chunk, you should lowercase every word in the query before embedding.
