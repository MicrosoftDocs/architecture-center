...
**Environment:** Production<br/>
**Azure facilitation:** [Microsoft Defender for APIs](/azure/defender-for-cloud/defender-for-apis-introduction) offers broad lifecycle protection, detection, and response coverage for APIs.<br/>
