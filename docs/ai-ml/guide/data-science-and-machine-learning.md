...
|-|-|-|
| [Azure&nbsp;AI&nbsp;Foundry&nbsp;portal](#azure-ai-foundry) | Unified development environment for AI and machine learning scenarios | Develop, evaluate, and deploy AI models and applications. The [Azure AI Foundry portal](https://ai.azure.com/) facilitates collaboration and project management across various Azure AI services. You can even use it as a common environment across multiple workload teams. |
...
For a comprehensive comparison of Machine Learning studio and the [Azure AI Foundry portal](https://ai.azure.com/), see [Azure AI Foundry portal or Machine Learning studio](/ai/ai-studio-experiences-overview). The following table summarizes the key differences between them:
