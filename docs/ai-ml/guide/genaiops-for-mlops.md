...
In a multiagent system, you need to monitor the availability, performance characteristics, and response quality and consistency of the agents that your orchestrator interfaces with. For guidance on designing these systems, see [AI agent orchestration patterns](ai-agent-design-patterns.md).
