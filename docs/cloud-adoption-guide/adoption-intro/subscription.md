...
However, in the foundational adoption stage, the strategy of creating a single subscription is sufficient to contain a relatively small number of resources. Follow the instructions in [how to: create an Azure subscription](subscription-how-to.md) to create your single subscription.
