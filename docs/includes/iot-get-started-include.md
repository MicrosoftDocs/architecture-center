...
- [Azure Load Testing for Azure IoT Hub](../guide/testing/load-testing/load-testing-with-custom-plugins.md): Use Azure Load Testing with custom plugins to simulate IoT device traffic against Azure IoT Hub.
