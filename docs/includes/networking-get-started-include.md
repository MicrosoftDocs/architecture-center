...
- [Hub-spoke network topology using Azure Virtual WAN](/azure/architecture/networking/architecture/hub-spoke-virtual-wan-architecture): Implement a hub-and-spoke network topology by using Azure Virtual WAN for Microsoft-managed hub infrastructure.
- [Massive-scale VWAN architecture design](/azure/architecture/networking/architecture/massive-scale-azure-architecture): Design a massive-scale Azure Virtual WAN network architecture across multiple Azure regions.
- [Virtual WAN architecture optimized for department-specific requirements](/azure/architecture/networking/architecture/performance-security-optimized-vwan): Optimize an Azure Virtual WAN architecture for department-specific performance and security requirements.
...
- [Use a split-brain DNS configuration to host a web app in Azure](/azure/architecture/example-scenario/networking/split-brain-dns): Configure split-brain DNS to host a web application with private and public resolution.
...
##### Guide to Private Link and DNS with Azure Virtual WAN

- [Guide to Private Link and DNS in Azure Virtual WAN](/azure/architecture/networking/guide/private-link-virtual-wan-dns-guide): Plan Azure Private Link and DNS integration with Azure Virtual WAN.
...
- [Single region scenario - Private Link and DNS in Azure Virtual WAN](/azure/architecture/networking/guide/private-link-virtual-wan-dns-single-region-workload): Configure Azure Private Link and DNS for a single-region workload that accesses a single resource.
...
- [SD-WAN integration with Azure hub-and-spoke network topologies](/azure/architecture/networking/guide/sd-wan-integration-hub-spoke-network-topologies): Integrate SD-WAN solutions with Azure hub-and-spoke network topologies.
