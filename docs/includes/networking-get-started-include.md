...
- [Private Link in hub-and-spoke network](/azure/architecture/networking/guide/private-link-hub-spoke-network): Use Private Link in a hub-and-spoke network topology.
...
- [Single region accessing single resource](/azure/architecture/networking/guide/private-link-virtual-wan-dns-single-region-workload): Configure Azure Private Link and DNS for a single-region workload that accesses a single resource.
