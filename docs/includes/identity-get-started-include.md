...
The following articles help you evaluate and select the best identity technologies for your workload requirements:
...
- [Deploy AD DS in an Azure virtual network](/azure/architecture/example-scenario/identity/adds-extend-domain): Extend an on-premises Active Directory domain to Azure to provide distributed authentication services in hybrid cloud environments.
...
- [Migrate cloud workloads across security tenants](/azure/architecture/solution-ideas/articles/migrate-cloud-workloads-across-security-tenants): Define and implement a cross-tenant workload migration strategy to address business transformations like acquisitions or divestitures.
