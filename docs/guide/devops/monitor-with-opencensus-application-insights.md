...
- The sendMessages span is split into two children spans: splitToMessages and writeToEventHubs. The sendMessages span requires those two suboperations to send messages.
