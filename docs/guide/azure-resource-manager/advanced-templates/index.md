...
- [Update a resource in an ARM template](update-resource.md). You can update a resource during deployment if necessary. For example, you'd need to do this if you can only specify some of the properties for a resource once other dependent resources are created.
