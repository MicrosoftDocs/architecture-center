...
description: Create n vision AI solution that uses Azure IoT Edge. Explore hardware recommendations, machine learning and storage requirements, alerting, and user interfaces.
author: MSKeith
ms.author: keith
ms.date: 01/27/2022
ms.topic: conceptual
