...
1. Label the data.
   ...
   You can label the data for a small number of images in-house, such as when you use transfer learning. If many images need labeling, you can hire a vendor for both data collection and labeling.
