...
1. Label the data.
   ...
   You can label the data for a few images in-house, like when you use transfer learning. If many images need labels, you can hire a vendor to handle both data collection and labeling.
