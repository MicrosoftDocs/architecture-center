...
1. **Communication Management Service.**  This service capability you build to manage and monitor chat threads, voice and video calls.  This service can create threads, create calls, invite users, call phone numbers, play audio, listen to DMTF tones and leverage many other call features through the Calling Automation SDK and REST APIs.
