...
- [Azure DocumentDB (vCore)](/azure/cosmos-db/mongodb/vcore/)
...
| Capability | Azure Cosmos DB for PostgreSQL | Azure Cosmos DB for NoSQL | Azure DocumentDB (vCore) | Azure Database for PostgreSQL flexible server | AI Search | Azure SQL Database |
| :---- | :--- | :--- | :--- | :--- | :--- | :--- |
...
1. <span id="a2">Vector search on embeddings is supported in Azure DocumentDB (vCore).</span>
...
| Search method | Azure Cosmos DB for PostgreSQL | Azure Cosmos DB for NoSQL | Azure DocumentDB (vCore) | Azure Database for PostgreSQL flexible server | AI Search | Azure SQL Database |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
...
1. <span id="b2">Azure DocumentDB (vCore) supports search and query by using text indexes.</span>
...
1. <span id="b6">Hybrid search that combines full-text and vector search with reciprocal rank fusion (RRF) is natively supported in Azure DocumentDB (vCore).</span>
...
| Indexing approach | Azure Cosmos DB for PostgreSQL | Azure Cosmos DB for NoSQL | Azure DocumentDB (vCore) | Azure Database for PostgreSQL flexible server | AI Search | Azure SQL Database |
| --- | --- | --- | --- | --- | --- | --- |
...
| Built-in vector comparison calculation | Azure Cosmos DB for PostgreSQL | Azure Cosmos DB for NoSQL | Azure DocumentDB (vCore) | Azure Database for PostgreSQL flexible server | AI Search | Azure SQL Database |
| --- | --- | --- | --- | ---| --- | --- |
...
1. <span id="g1">Azure DocumentDB (vCore) is [supported as a data source](/azure/ai-services/openai/concepts/use-your-data?tabs=mongo-db#supported-data-sources) for Azure OpenAI on your data.</span>
