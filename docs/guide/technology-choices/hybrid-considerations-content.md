...
1. **Container-based** deployments can use Azure Arc-enabled Kubernetes. **VM-based** deployments can use Azure Arc-enabled servers, Azure Arc-enabled VMware vSphere, or Azure Arc-enabled SCVMM. **SQL** database deployments can use Azure Arc-enabled data services.
