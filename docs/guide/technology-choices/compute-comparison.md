...
| Minimum number of nodes | 1 <a href="#note2"><sup>2</sup></a>  | 1 | 5 <a href="#note3"><sup>3</sup></a>. Azure VM Scale Set supported | No dedicated nodes <a href="#note1"><sup>1</sup></a> | 3. Azure VM Scale Set not supported | 2 | 1 <a href="#note4"><sup>4</sup></a> |
...
| Web hosting | Agnostic | Built in | Self-host, IIS | Not applicable | Self-host, IIS | Built-in (IIS) | No |
| OS | Windows, Linux | Windows, Linux  | Windows, Linux | Not applicable | Windows,  Linux | Windows | Windows, Linux |
