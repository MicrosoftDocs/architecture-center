...
:::image type="content" source="./images/compute-choices.svg" alt-text="Diagram that shows a decision tree for Azure compute services." lightbox="./images/streamcompute-choices.svg" border="false":::
