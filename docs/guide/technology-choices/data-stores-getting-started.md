...
| Virtual network connectivity support | Virtual network service endpoint | Native virtual network implementation | Virtual network injection | Virtual network injection (Flexible Server only) | Native virtual network implementation | Virtual network service endpoint | Virtual network service endpoint | Virtual network service endpoint | [Managed virtual network support](/power-platform/admin/vnet-support-overview) |
