...
| [Azure Data Box](/azure/databox/) | Azure Data Box is a collection of on-premises network devices that allows for offline data transfer into and out of Azure when time, network availabilty, or cost are limiting factors. Depending on your data size, you can choose from Data Box Disk, Data Box, or Data Box Heavy. |
