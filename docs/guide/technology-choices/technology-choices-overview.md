...
|Article |Summary  |
|---------|---------|
|[Choose an Azure Cognitive Services technology](../../data-guide/technology-choices/ai-services.md)|     Learn about cognitive services that you can use in AI applications and data flows.    |
