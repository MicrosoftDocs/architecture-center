...
1. [Defender for containers](/azure/defender-for-cloud/defender-for-container-registries-introduction) scans the container images when they are pushed to Azure Container Registry, and reports the image vulnerabilities to Azure Security Center. Defender for containers performs periodic scans of running containers in Azure Kubernetes Service and of container images stored in Azure Container Registry. Defender for Containers also provides real-time threat protection for supported containerized environments and generates alerts for suspicious activities. You can use this information to quickly remediate security issues and improve the security of your containers. 
