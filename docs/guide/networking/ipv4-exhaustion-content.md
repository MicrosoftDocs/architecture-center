...
:::image type="content" source="./images/ipv4-exhaustion-hub-spoke-virtual-net-peering.svg" alt-text="Diagram that shows the dual virtual network topology for landing zones." border="false" lightbox="./images/ipv4-exhaustion-hub-spoke-vnet-peering.svg":::
*Download a [PowerPoint file](https://arch-center.azureedge.net/ipv4-exhaustion-hub-spoke-virtual-net-peering.pptx) of this architecture.*
