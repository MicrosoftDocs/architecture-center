...
|[Multiple forests with AD DS and Microsoft Entra ID](../example-scenario/wvd/multi-forest.yml)|Learn how to create multiple Active Directory forests with Azure Virtual Desktop. Azure NetApp Files is one recommended storage solution for the scenario.|Virtual Desktop|
...
|[Oracle Database migration: Lift and shift](/azure/virtual-machines/workloads/oracle/oracle-migration)|Lift and shift your Oracle database from an Oracle environment to Azure Virtual Machines.|Oracle|
...
|[Unified logging for microservices apps](/azure/architecture/best-practices/monitoring)|Learn about logging, tracing, and monitoring for microservices apps.|Microservices|
