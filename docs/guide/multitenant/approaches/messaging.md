...
The number of tenants, the complexity of message flows and `eventstream`, the volume of messages, the expected traffic profile, and the isolation level should drive the decisions when planning for a messaging or eventing infrastructure.
