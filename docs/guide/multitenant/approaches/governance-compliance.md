...
Consider following the [Deployment Stamps pattern](overview-content.md#deployment-stamps-pattern) when you need to comply with tenant-specific requirements.
