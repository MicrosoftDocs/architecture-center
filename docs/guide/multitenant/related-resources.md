...
* [Guide to design a secure multitenant RAG inferencing solution](../../ai-ml/guide/secure-multitenant-rag.yml): This document describes how to apply the Retrieval-Augmented Generation (RAG) pattern within multitenant solutions, where tenant-specific data needs to be used for inferencing.
