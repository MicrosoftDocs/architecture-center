...
![Diagram showing revenue increase, as the number of devices increasess.](media/pricing-models/per-unit.png)
...
You might choose to offer a free tier of your service, with basic functionality and no service-level guaranteees. You then might offer a separate paid tier, with additional features and a formal service-level agreement (as shown in the following diagram).
