...
Whatever your architecture, it's essential that you have a clear understanding of your customers' or tenants' requirements. If you have made sales commitments to customers, or have contractual obligations or compliance requirements to meet, you need to know what these are when you architect your solution. But equally, your customers may have implicit expectations about how things _should_ work, or how you _should_ behave, that could affect the way you design a multitenant solution. As an example, imagine you're building a multitenant solution that you sell to businesses in the financial services industry. Your customers may have very strict security requirements, and need you to provide a comprehensive list of every domain name that your solution uses so they can add it to their firewall's allowlist. This requirement affects the Azure services you use and the level of isolation you have to provide between your tenants. There may be many similar expectations, both explicit and implicit, that you need to consider across your whole solution.
