...
description: This article describes the features of Azure OpenAI that are useful when you work with multitenanted systems, and it provides links to guidance for how to use Azure OpenAI in a multitenant solution.
author: soferreira
...
[Azure OpenAI Service](https://learn.microsoft.com/azure/ai-services/openai/overview) is a comprehensive offering that enables access to OpenAI's powerful language models. On this page, we describe some of the features of [Azure OpenAI Service](https://learn.microsoft.com/azure/ai-services/openai/overview)  that are useful for multitenant solutions, and then we provide links to the guidance that can help you when you're planning how you're going to using this service.

## Isolation models

When working with a multitenant system using [Azure OpenAI Service](https://learn.microsoft.com/azure/ai-services/openai/overview), you need to decide the level of isolation that you want to adopt. The choice of isolation models you use depends on the following factors:
...
If your tenants configure network access controls on their Azure OpenAI, make sure you'll be able to access it.
...
You can use managed identities from Azure Active Directory (Azure AD) to enable access to Azure OpenAI from other resources that are authenticated by Azure AD. When you use managed identities, you don't need to use an Azure OpenAI API key. You can grant specific permissions to your Azure OpenAI identity for role-based access control.

When you use managed identities, keep your choice of isolation model in mind. For more information, see [Azure OpenAI Service with managed identities](azure-docs/articles/cognitive-services/openai/how-to/managed-identity).
 ...
 * [Arsen Vladimirskiy](http://linkedin.com/in/) | TODO
 * [Daniel Scott-Raynsford](http://linkedin.com/in/) | TODO
 * [John Downs](http://linkedin.com/in/) | TODO
 * [Landon Pierce](https://www.linkedin.com/in/) | TODO
 * [Paolo Salvatori](http://linkedin.com/in/paolo-salvatori) | TODO
