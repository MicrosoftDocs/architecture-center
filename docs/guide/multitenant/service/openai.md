...
[Azure OpenAI Service](/azure-docs/articles/ai-services/openai/overview.md) is a comprehensive offering that enables access to OpenAI's powerful language models. On this page, we highlight key features of the Azure OpenAI Service that are beneficial for multi-tenant solutions. Furthermore, we provide links to useful resources that can assist you in planning your approach to using this service.
