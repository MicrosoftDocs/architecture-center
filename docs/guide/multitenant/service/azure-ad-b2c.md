...
It's important to note that the deployment & maintenance requirements are still higher than when you use a single Azure AD B2C tenant. As such, you need to design and implement a strategy for deploying & maintaining multiple tenants across your environment.
