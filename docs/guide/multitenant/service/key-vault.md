...
In some situations, your tenants might create vaults in their own Azure subscriptions and want to grant your application access to work with secrets, certificates, or keys. This approach might be appropriate when you allow *customer-managed keys* (CMKs) for encryption within your solution.
