...
* If you use shared infrastructure, plan for how you'll mitigate [Noisy Neighbor](../../antipatterns/noisy-neighbor/index.md) concerns. Ensure that one tenant can't reduce the performance of the system for other tenants.
