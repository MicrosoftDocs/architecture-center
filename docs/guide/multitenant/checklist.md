...
* Avoid [antipatterns](./approaches/deployment-configuration-content.yml#antipatterns-to-avoid) such as running separate versions of the solution or hardcoding tenant-specific configurations or logic or manual deployments.
