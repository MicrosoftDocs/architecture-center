...
It also has a [hard-limit of 1 million registrations](/azure/iot-dps/about-iot-dps#quotas-and-limits) per service instance. You should design with this limit as your design limit to avoid issues in the future.
