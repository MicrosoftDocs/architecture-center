...
:::image type="complex" source="media/databricks-solution-architecture.svg" alt-text="Architecture diagram of the reference solution that adds Azure Databricks as a parallel analytics option to Azure Data Explorer." lightbox="media/databricks-solution-architecture.svg" border="false":::
