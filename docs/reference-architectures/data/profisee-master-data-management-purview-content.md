...
:::image type="content" source="images/profisee-microsoft-purview-integration-detail.png" alt-text="Diagram that shows how Profisee MDM integrates with Microsoft Purview to ingest, model, and govern data." border="false":::
