            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Deploy VMs and a virtual network configured for an N-tier application using SQL Server on Windows.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Deploy an N-tier application to two regions for high availability, using SQL Server Always On Availability Groups.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    ...
                    <div class="cardText">
                        ...
                        <p>Deploy Linux VMs and a virtual network configured for an N-tier application using Apache Cassandra.</p>
                    </div>
                </div>
            </div>
        </div>
...
<!-- Multi-region Linux -->
<li style="display: flex; flex-direction: column;">
    <a href="./multi-region-cassandra.md" style="display: flex; flex-direction: column; flex: 1 0 auto;">
        <div class="cardSize" style="flex: 1 0 auto; display: flex;">
            <div class="cardPadding" style="display: flex;">
                <div class="card">
                    <div class="cardImageOuter">
                    ...
                    <div class="cardText">
                        <h3>Multi-region N-tier application with SQL Server</h3>
                        <p>Deploy an N-tier application to two regions for high availability, using a multi-region Cassandra cluster.</p>
                    </div>
                </div>
            </div>
        </div>
