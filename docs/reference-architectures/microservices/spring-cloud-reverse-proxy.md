...
> Note that this already assumes your reverse proxy does not override the HTTP `Host` header and keeps the original host name intact: see the [Host name preservation best practice](../../best-practices/host-name-preservation.yml) guidance for more information.
...
-->
- [Host name preservation best practice](../../best-practices/host-name-preservation.yml)
