...
The above architecture depicts a highly available deployment, with SAP HANA contained on two or more virtual machines. Following components are used.
