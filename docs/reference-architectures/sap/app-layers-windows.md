...
description:  Proven practices for running an SAP application layer on Windows virtual machines in a high availability environment on Azure.
author: njray
ms.date: 4/15/18
---

# Deploy SAP Application Layer (NetWeaver) on Windows using Azure
