...
This example architecture also uses a [proximity placement group](/azure/virtual-machines/workloads/sap/sap-proximity-placement-scenarios) to reduce network latency between virtual machines. This type of group places a location constraint on virtual machine deployments and minimizes the physical distance between them.  Over the past years, Azure has grown and number of datacenters increased.  This document has updated guidance regarding the use of PPGs so it's important to have a good understanding of this information before a production deployment. 
