...
_Azure ML based alternative:_
This architecture is providing a pure R experience, and it does not use the [Python](https://docs.microsoft.com/en-us/python/api/overview/azure/ml/intro?view=azure-ml-py) oriented [Azure Machine Learning Services](https://docs.microsoft.com/en-us/azure/machine-learning/service/overview-what-is-azure-ml#what-is-azure-machine-learning-service-1) (__AzureML SDK__), which is a mature cloud service for developing AI solutions at scale. AzureML SDK provides an easy path for development and deployment of containerized scoring scripts, so we are also provide [here](https://github.com/microsoft/AMLSDKRModelsOperationalization) an alternative solution that shows how to use [conda](https://conda.io/en/latest/) to [install R](https://docs.anaconda.com/anaconda/user-guide/tasks/use-r-language/) and R packages to leverage AzureML SDK via [rpy2](https://rpy2.bitbucket.io/) Python package. The value in using this alternative to operationalize R models is that one does not need to know flask, and can reuse AzureML SDK expertise, which may be useful for teams that are comfortable using both R and Python languages for their data science projects. The implementation of this alternative architecture is [available](https://github.com/microsoft/AMLSDKRModelsOperationalization) on GitHub.
