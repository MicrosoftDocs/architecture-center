...
For an example *local.settings.json* file, see [sample.local.settings.json](https://github.com/mspnp/gridwich/src/Gridwich.Host.FunctionApp/src/sample.local.settings.json).
