...
Software component composition uses the `ConfigureServices` class within the Azure Functions App. The `ConfigureServices` class defines which concrete classes are available in the IoC container for the app.
