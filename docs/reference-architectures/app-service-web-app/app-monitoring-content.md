...
High availability considerations for the app you run, however, are the developer's responsibility. For information about scale, for example, see the [scalability considerations](../../web-apps/architectures/basic-web-app.yml#performance-efficiency) in the basic web application reference architecture. After an app is deployed, you can set up tests to [monitor its availability][monitor its availability] using Application Insights.
...
[Basic web application reference architecture]: /azure/architecture/web-apps/architectures/basic-web-app#performance-efficiency
