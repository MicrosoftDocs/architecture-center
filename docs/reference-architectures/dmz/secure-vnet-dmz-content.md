...
Use this [preconfigured estimate in the Azure pricing calculator](https://azure.com/e/7e0622150a1e41ddbcf70b6e3ebf5ff4) as a starting point to estimate the costs for your scenario. It includes the networking components described in this article with example VMs.
