...
The VpnGw1 gateway SKU supports sustained throughput of up to 650 Mbps. The VpnGw2 gateway SKU provides up to 1 Gbps and the VpnGw3 SKU, 1.25Gbps. For higher bandwidths, consider upgrading to an ExpressRoute gateway and an ExpressRoute circuit. ExpressRoute provides up to 10 Gbps bandwidth with lower latency than a VPN connection.
