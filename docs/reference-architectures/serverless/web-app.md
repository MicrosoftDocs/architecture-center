...
The web application in this reference architecture is developed using [JAMstack](https://jamstack.org/), a methodology closely related to serverless. See the section on [frontend deployment](#frontend-deployment) to see how this methodology enhances the development, build and deployment.
