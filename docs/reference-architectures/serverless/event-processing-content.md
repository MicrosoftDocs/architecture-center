...
As you deploy your services you will need to monitor them. Consider using [Azure Resource Manager][arm-template] to enable the developers to monitor performance and detect issues.
...
- **Database operations.** The way you get charged for your database operations depends on the type of Azure Cosmos DB account you are using.
  - In [serverless mode][cosmosdb-serverless], you don't have to provision any throughput when creating resources in your Azure Cosmos account. At the end of your billing period, you get billed for the amount of [Request Units][ru] that has been consumed by your database operations.
