...
You are ultimately responsible for your own PCI DSS compliance. Have a clear understanding of your responsibilities by reading the PCI requirements to understand their intent, studying the matrix for Azure so that the implementation is ready for a successful assessment.


## Recommended learning approach for an AKS hosted workload
