...
If your workload has typical app hosting needs and you want to automate common operator tasks, [AKS Automatic](/azure/aks/intro-aks-automatic) can be a good starting option for production. AKS Automatic includes built-in configuration for node management, scaling, security policies, and upgrades. It provisions and operates a managed system node pool, reducing the number of virtual machines you manage as part of your cluster.
