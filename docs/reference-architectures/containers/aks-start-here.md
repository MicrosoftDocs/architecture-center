...
:::image type="content" source="images/aks-journey.svg" alt-text="Architecture diagram shows visualizes your journey through learn, align, baseline, workload, and then into a loop of operate, best practices, iterate.":::
