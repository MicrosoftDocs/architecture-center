...
For administrative access, you might create a Microsoft Entra group for each region, and grant the members of each group full access to the corresponding cluster stamp.
