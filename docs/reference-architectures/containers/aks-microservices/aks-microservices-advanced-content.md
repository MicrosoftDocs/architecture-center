...
- The [Cost section in the Microsoft Azure Well-Architected Framework](..//azure/architecture/framework/cost/overview.md) describes cost considerations. Use the [Azure pricing calculator](https://azure.microsoft.com/pricing/calculator) to estimate costs for your specific scenario.
