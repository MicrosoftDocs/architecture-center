---
title: Case study – Contoso Bicycle
description: A fictitious company, Contoso Bicycle that needs guidance to deploy their workload for the first time in an Azure Kubernetes Service (AKS) cluster.
