...
Here are some considerations. For more information, see the [Operational Excellence](..//azure/architecture/framework/devops/release-engineering-cd.md) pillar.
...
-   If your workload is expected exist for a long period, you can commit to one- or three-year Reserved Virtual Machine Instances to reduce the node costs. For more information, see [Reserved VMs](..//azure/architecture/framework/cost/optimize-vm.md#reserved-vms).
