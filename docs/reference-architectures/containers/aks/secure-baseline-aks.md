...
and monitoring of the cluster based on an organization’s business requirements and follows the [Azure Well-Architected Framework](azure/architecture/framework/) recomendations.
