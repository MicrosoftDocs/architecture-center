...
Kubernetes is a powerful ecosystem that extends beyond Azure and Microsoft technologies. When you deploy an AKS cluster, you take responsibility for numerous decisions about how your cluster should be designed and operated. These decisions have important consequences and you need to consider each decision carefully. Many parts of the Kubernetes ecosystem are filled by open- and closed-source components from a variety of vendors, including Microsoft and many others. The landscape changes frequently, and you might need to revisit decisions regularly. By adopting Kubernetes, you're acknowledging that you need its capabilities and that you're prepared to invest on an ongoing basis.
