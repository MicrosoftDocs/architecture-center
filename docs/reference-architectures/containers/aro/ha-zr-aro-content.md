...
* [Azure Monitor](/azure/well-architected/service-guides/azure-log-analytics) and [Application Insights](/azure/well-architected/service-guides/application-insights/security) collect service logs and application performance metrics for observability. In this architecture, Azure Monitor is the log sync for both platform and workload logs. Application insights is specifically logs and metrics originating in the workload code.
