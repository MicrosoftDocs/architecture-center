...
Architecture refers to the arrangement and distribution of components supporting your web app. Architecture availability is an important metric. The availability of your web app architecture should meet or exceed the service level objective (SLO) for the web app. Use availability metrics when estimating architecture availability, not durability. Durability applies to data storage, and it ensures the integrity of your data. Durability service level agreements are generally higher than availability service level agreements. For more information, see [service level objective](./plan-implementation-content.md#service-level-objective).
