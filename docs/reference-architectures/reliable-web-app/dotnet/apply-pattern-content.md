This article describes how to apply the reliable web app pattern for .NET. The companion article describes how to [plan the implementation](plan-implementation.yml). The reliable web app pattern provides implementation guidance for web applications that you have recently migrated to the cloud. The pattern focuses on the minimal, essential changes you should make to ensure the success of your web app in the cloud.
