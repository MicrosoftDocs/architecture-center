...
There are two articles in this series and a reference implementation (sample web app). This article describes how to plan the implementation of the reliable web app pattern for .NET. The companion article describes how to [apply the pattern](apply-pattern.yml). A [reference implementation](https://aka.ms/eap/rwa/dotnet) of the pattern is available for you to deploy.
