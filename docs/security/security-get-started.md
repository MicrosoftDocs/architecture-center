...
- [Microsoft Entra ID](/entra/fundamentals/what-is-entra) is the Microsoft cloud-based identity and access management service. It provides single sign-on (SSO), multifactor authentication (MFA), and conditional access to guard against identity-based attacks.
