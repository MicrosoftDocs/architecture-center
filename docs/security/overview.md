...
validating security assurances. The “Zero Trust” approach is described in the [Security Design Principles](/azure/architecture/security/minimize-security-risks#enforce-conditional-access-for-admins-zero-trust) section in more detail.
