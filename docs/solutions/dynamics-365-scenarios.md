...
|[Eventual consistency between multiple Power Apps instances](../reference-architectures/power-platform/eventual-consistency.yml)|Handle dependent data in a resilient way in Power Apps. Includes information about replicating data between Dynamics 365 instances.|Web|
