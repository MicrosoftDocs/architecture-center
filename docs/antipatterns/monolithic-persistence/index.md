...
:::image type="content" source="./_images/MonolithicScenarioLoadTest.jpg" alt-text="Graph that shows load test performance results for the SQL-based controller." lightbox="./_images/MonolithicScenarioLoadTest.jpg" border="false":::
...
:::image type="content" source="./_images/MonolithicDatabaseUtilization.jpg" alt-text="Graph that shows the database monitor in the Azure classic portal showing resource utilization of the database." lightbox="./_images/MonolithicDatabaseUtilization.jpg" border="false":::
...
:::image type="content" source="./_images/PolyglotScenarioLoadTest.jpg" alt-text="Graph that shows the load test performance results using the Polyglot controller." lightbox="./_images/PolyglotScenarioLoadTest.jpg" border="false":::
...
:::image type="content" source="./_images/PolyglotDatabaseUtilization.jpg" alt-text="Graph that shows the database monitor in the Azure classic portal showing resource utilization of the database in the polyglot scenario." lightbox="./_images/PolyglotDatabaseUtilization.jpg" border="false":::
...
:::image type="content" source="./_images/LogDatabaseUtilization.jpg" alt-text="Graph that shows the database monitor in the Azure classic portal showing resource utilization of the log database in the polyglot scenario." lightbox="./_images/LogDatabaseUtilization.jpg" border="false":::
