...
:::image type="content" source="./_images/LoadTestResultsClientSide1.jpg" alt-text="Load test results for the GetAllFieldsAsync method" lightbox="./_images/LoadTestResultsClientSide1.jpg" border="false":::
...
:::image type="content" source="./_images/LoadTestResultsClientSide2.jpg" alt-text="Load test results for the AggregateOnClientAsync method" lightbox="./_images/LoadTestResultsClientSide2.jpg" border="false":::
...
:::image type="content" source="./_images/TelemetryAllFields.jpg" alt-text="Telemetry for the `GetAllFieldsAsync` method" lightbox="./_images/TelemetryAllFields.jpg" border="false":::
...
:::image type="content" source="./_images/TelemetryAggregateOnClient.jpg" alt-text="Telemetry for the `AggregateOnClientAsync` method" lightbox="./_images/TelemetryAggregateOnClient.jpg" border="false":::
...
:::image type="content" source="./_images/QueryDetails.jpg" alt-text="The Query Details pane in the Windows Azure SQL Database management portal" lightbox="./_images/QueryDetails.jpg" border="false":::
...
:::image type="content" source="./_images/LoadTestResultsDatabaseSide1.jpg" alt-text="Load test results for the GetRequiredFieldsAsync method" lightbox="./_images/LoadTestResultsDatabaseSide1.jpg" border="false":::
...
:::image type="content" source="./_images/TelemetryRequiredFields.jpg" alt-text="Telemetry for the `GetRequiredFieldsAsync` method" lightbox="./_images/TelemetryRequiredFields.jpg" border="false":::

Load testing using the `AggregateOnDatabaseAsync` method generates the following results:

:::image type="content" source="./_images/LoadTestResultsDatabaseSide2.jpg" alt-text="Load test results for the AggregateOnDatabaseAsync method" lightbox="./_images/LoadTestResultsDatabaseSide2.jpg" border="false":::
...
:::image type="content" source="./_images/TelemetryAggregateInDatabase.jpg" alt-text="Telemetry for the `AggregateOnDatabaseAsync` method" lightbox="./_images/TelemetryAggregateInDatabase.jpg" border="false":::
