...
- [Azure Virtual Network](/azure/well-architected/service-guides/virtual-network) is the foundational building block for private networking in Azure. It enables secure communication between Azure resources, on-premises networks, and the internet. In this architecture, it forms the hub-and-spoke topology, which supports dual-stack (IPv4 and IPv6) configurations for centralized and isolated connectivity.
