...
If there are many spoke networks in the topology, the number of required interconnections grows exponentially with the number of spokes. Azure Virtual Network Manager offers the most efficient way of managing these direct connections at scale.
