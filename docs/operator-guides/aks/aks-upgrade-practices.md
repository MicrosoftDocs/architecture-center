...
|--|--|--|--|--|--|
|Node OS security patches |[Nightly](/azure/aks/concepts-vulnerability-management#worker-nodes)|Yes |Automatic (weekly), Manual (nightly)|Node|[AKS Upgrades](/azure/aks/upgrade)|
