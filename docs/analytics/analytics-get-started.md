...
:::image type="complex" border="false" source="_images/analytics-get-started-diagram.svg" alt-text="Diagram that shows the analytics solution journey on Azure." lightbox="_images/analytics-get-started-diagram.svg":::
...
High-quality analytics start with robust, trustworthy data. At the highest level, [information security](/azure/well-architected/security/) practices help ensure that your data is protected in transit and at rest. Access to that data must also be trusted. Trustworthy data implies a design that implements:

- [Governance policies](/azure/well-architected/security/data-classification) - Define clear data ownership, classification, and access policies.
...
- **On-premises integration**: [Unified hybrid and multicloud operations](/azure/cloud-adoption-framework/scenarios/hybrid/) - Connect on-premises databases to cloud analytics.
