...
For a list of Azure services that support Availability Zones, per Azure region, refer to the [Availability Zones documentation](/azure/availability-zones/az-overview#services-support-by-region).
