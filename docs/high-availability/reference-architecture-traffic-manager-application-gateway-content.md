...
- [Azure Virtual Network](/azure/well-architected/service-guides/azure-virtual-network/reliability) is a secure private network in the cloud. It connects virtual machines to one another, to the Internet, and to cross-premises networks.
