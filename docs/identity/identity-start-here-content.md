...
- For a comparison of various authentication options, see [Choose the right authentication method for your Microsoft Entra hybrid identity solution][Choose the right authentication method for your Microsoft Entra ID hybrid identity solution].
...
- For information on deploying Microsoft Entra ID, see these resources:
  ...
  - [Microsoft Entra feature deployment guide][Microsoft Entra ID feature deployment guide]
  - [Microsoft Entra deployment plans][Microsoft Entra ID deployment plans]
...
- With capabilities like automation, self-service, and single sign-on, Microsoft Entra ID can boost productivity. For general information on benefitting from this service, see [Four steps to a strong identity foundation with Microsoft Entra ID][Four steps to a strong identity foundation with Microsoft Entra ID].

- To check whether your Microsoft Entra implementation aligns with the Azure Security Benchmark version 2.0, see [Azure security baseline for Microsoft Entra ID][Azure security baseline for Microsoft Entra ID].
...
- For general information and guidelines on migrating applications to Microsoft Entra ID, see these articles:
  ...
  - [Move application authentication to Microsoft Entra ID][Move application authentication to Microsoft Entra ID]
  - [Migrate application authentication to Microsoft Entra ID][Migrate application authentication to Microsoft Entra ID]
  - [Review the application activity report][Review the application activity report]
  - [Resources for migrating applications to Microsoft Entra ID][Resources for migrating applications to Microsoft Entra ID]
...
- To stay on top of recent developments, see [What's new in Microsoft Entra ID?][What's new in Microsoft Entra ID?].
...
- [Introduction to Microsoft Entra tenants][Introduction to Microsoft Entra ID Tenants]
...
- [Microsoft Entra identity management and access management for AWS][Microsoft Entra ID identity management and access management for AWS]
...
[Microsoft Entra ID deployment plans]: /entra/architecture/deployment-plans?toc=/azure/architecture/toc.json&bc=/azure/architecture/_bread/toc.json
[Microsoft Entra ID feature deployment guide]: /entra/fundamentals/concept-secure-remote-workers?toc=/azure/architecture/toc.json&bc=/azure/architecture/_bread/toc.json
[Microsoft Entra ID identity management and access management for AWS]: ../reference-architectures/aws/aws-azure-ad-security.yml
...
[Azure security baseline for Microsoft Entra ID]: /security/benchmark/azure/baselines/aad-security-baseline?toc=/azure/architecture/toc.json&bc=/azure/architecture/_bread/toc.json
...
[Migrate application authentication to Microsoft Entra ID]: /entra/identity/enterprise-apps/migrate-adfs-apps-phases-overview?toc=/azure/architecture/toc.json&bc=/azure/architecture/_bread/toc.json
[Move application authentication to Microsoft Entra ID]: /entra/identity/enterprise-apps/migrate-adfs-apps-stages?toc=/azure/architecture/toc.json&bc=/azure/architecture/_bread/toc.json
...
[Resources for migrating applications to Microsoft Entra ID]: /entra/identity/enterprise-apps/migration-resources?toc=/azure/architecture/toc.json&bc=/azure/architecture/_bread/toc.json
...
[What's new in Microsoft Entra ID?]: /entra/fundamentals/whats-new?toc=/azure/architecture/toc.json&bc=/azure/architecture/_bread/toc.json