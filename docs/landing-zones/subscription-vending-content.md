...
*Figure 1. Example implementation of subscription vending automation. For a visualization of the flow, see [subscription vending process flow](https://github.com/stephen-sumner/architecture-center-pr/blob/subscription-vending/docs/landing-zones/images/subscription-vending-process-flow.md)*
