...
| [Azure Red Hat OpenShift landing zone accelerator](/azure/cloud-adoption-framework/scenarios/app-platform/azure-red-hat-openshift/landing-zone-accelerator) | An open source collection of terraform Templates that represents a potential golden state and strategic design path for an Azure Red hat Openshift (ARO) deployment using a combination of Azure and Red hat resources. |
