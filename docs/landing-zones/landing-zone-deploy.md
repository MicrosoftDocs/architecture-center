...
| Deployment option | Description |
| --- | ---|
| [Bicep subscription vending](https://aka.ms/lz-vending/bicep) | The subscription vending Bicep module is designed to accelerate deployment of the individual landing zones (also known as subscriptions) within a Microsoft Entra tenant on Enterprise Agreement (EA), Microsoft Customer Agreement (MCA), and Microsoft Partner Agreement (MPA) billing accounts. |
