...
<br>
- An SLO of 99.8% uptime/availability results in the following periods of allowed downtime / unavailability for the applications deployed within Arc VMs running on Azure Stack HCI:
Weekly: 20m 9.6s
Monthly: 1h 26m 56s
