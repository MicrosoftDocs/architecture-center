...
> [!IMPORTANT]
> We recommend using mirroring for most performance-sensitive workloads. If you have more than two servers, we recommend using three-way mirroring instead of two-way mirroring. To learn more about how to balance performance and capacity depending on your workload, see [Plan volumes][s2d-plan-volumes].
