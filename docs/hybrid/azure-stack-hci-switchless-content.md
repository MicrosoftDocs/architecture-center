...
Azure Arc capabilities extend the scope of Azure integration for Azure Stack HCI virtualized and containerized workloads, by using the following functionality:
