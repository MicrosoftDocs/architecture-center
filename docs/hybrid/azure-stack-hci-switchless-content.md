...
1. Depending on your chosen solution SKU (_Premier solution, Integrated system or Validated nodes_) either the hardware / SI partner, or your employees will now be able to deploy the Azure Stack HCI software. This step starts by enrolling the physical nodes as Arc-enabled Servers, then starting the Azure Stack HCI cloud deployment process.
