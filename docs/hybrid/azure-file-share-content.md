...
- **Clients** are AD DS domain-joined computers for users. In this architecture, clients access Azure file shares by using their existing credentials, which maintains a familiar experience while taking advantage of cloud-based storage.
