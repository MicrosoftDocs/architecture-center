...
- Azure file shares currently support the following data redundancy options:
  ...
  - **Geo-zone-redundant storage (GZRS)**. Data is copied synchronously across three or more Azure availability zones in the primary region using ZRS. Your data is then copied asynchronously to a single zone in the secondary region.
