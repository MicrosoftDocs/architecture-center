...
- [Azure Arc-enabled SCVMM](/azure/azure-arc/system-center-virtual-machine-manager/overview) is an Azure Arc service that helps you simplify the management of hybrid IT estate distributed across SCVMM managed environment and Azure.
