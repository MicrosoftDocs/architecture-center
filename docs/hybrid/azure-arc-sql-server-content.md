...
- [Azure Arc-enabled servers][azure-arc-enabled-servers-service-page] provides management of Windows and Linux machines outside Azure on your corporate network or other cloud provider. In this architecture, it provides the foundation for managing SQL Server instances as hybrid Azure resources.
...
- [Microsoft Defender for Cloud][azure-security-center-service-page] is a security platform that provides unified security management and threat protection. In this architecture, it strengthens the security posture of datacenters and enables advanced threat detection across hybrid workloads.
