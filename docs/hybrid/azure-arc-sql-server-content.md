...
- [Azure Arc enabled SQL Managed Instance][azure-arc-enabled-sql-managed-instance-service-page]. This Azure SQL data service can be created on your choice of infrastructure that hosts Azure Arc enabled data services.
- [Azure Arc-enabled SCVMM](/azure/azure-arc/system-center-virtual-machine-manager/overview?toc=/azure/cloud-adoption-framework/toc.json&bc=/azure/cloud-adoption-framework/_bread/toc.json) is an Azure Arc service that helps you simplify the management of hybrid IT estate distributed across SCVMM managed environment and Azure.
