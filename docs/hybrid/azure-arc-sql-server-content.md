...
- [Azure Arc-enabled VMware vSphere](/azure/azure-arc/vmware-vsphere/overview) is an Azure Arc service that helps you simplify management of hybrid IT estate distributed across VMware vSphere and Azure.
- [Arc-enabled System Center Virtual Machine Manager (SCVMM)](/azure/azure-arc/system-center-virtual-machine-manager/overview) is an Azure Arc service that helps you simplify the management of hybrid IT estate distributed across SCVMM managed environment and Azure.
