...
The most simple and recommended design is using a single private DNS zone across all your Azure regions. Azure private DNS zones are global resources that aren't attached to any region in particular, so even in a catastrophic Azure regional failure, private DNS zones should continue to operate. The following diagram describes this design:
