...
<!-- Consider replacing "evergreen" with something more easily translatable, like "always up to date" -->
...
<!-- First "and" with "or" because this ia a dececion that needs to be made implement one or the other. Sentece should be "...you need to decide whether the data controller will operate in the [Directly Connected or Indirectly Connected connectivity mode][azure-arc-data-services-connectivity-modes]." -->
